...
// Utilitare pentru Ã®mbunÄƒtÄƒÈ›irea SEO-ului pe site
...
export function generateEnhancedMetadata(config: EnhancedSEOConfig) {
  const baseUrl = process.env.NEXT_PUBLIC_SITE_URL || "https://www.anexa1.ro";
...
// Structured data pentru organizaÈ›ie
export function generateOrganizationStructuredData() {
  ...
  return {
    ...
    "description": "Tipar digital profesional - bannere, afiÈ™e, canvas, autocolante È™i materiale publicitare",
    "address": {
      "@type": "PostalAddress",
      "addressCountry": "RO",
    ...
    "sameAs": [
      "https://www.facebook.com/anexa1.ro",
      "https://www.instagram.com/anexa1.ro"
    ],
    "service": [
      {
        "@type": "Service",
        "name": "Bannere publicitare",
        "description": "Print bannere PVC outdoor È™i indoor"
      },
      {
        "@type": "Service",
        "name": "AfiÈ™e È™i postere",
        "description": "TipÄƒrire afiÈ™e A4, A3, A2, A1, A0"
      },
      {
        "@type": "Service",
        "name": "Canvas personalizat",
        "description": "Tablouri canvas pe pÃ¢nzÄƒ Ã®ntinsÄƒ pe È™asiu"
      }
    ]
  };
}
...
export function generateWebsiteStructuredData() {
  ...
  return {
    ...
    "name": "Anexa1.ro",
    "url": baseUrl,
    "description": "Tipar digital È™i producÈ›ie publicitarÄƒ online cu configuratoare instant",
    "publisher": {
      "@type": "Organization",
      "name": "Anexa1.ro"
    },
