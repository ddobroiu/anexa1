...
const STATIC_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    contentHtml: `
      ...
      <p>Configuratorul calculează prețul instant, pe baza dimensiunii, materialului și finisajelor alese, fără să aștepți o ofertă prin email. Odată confirmată comanda și validat fișierul grafic, materialul intră direct la print cu cerneluri UV rezistente la soare, urmat de tăiere la dimensiune, aplicarea tivului la cald și fixarea capselor – întregul proces durează de regulă 2-4 zile lucrătoare pentru un banner standard. Pentru comenzi multiple sau dimensiuni neobișnuite, termenul se comunică punctual la confirmare, înainte de a intra în producție.</p>
        ...
        <table class="min-w-full bg-white">
          ...
          <tbody class="divide-y divide-slate-100">
            ...
            <tr>
              ...
              <td class="px-6 py-4 text-center text-blue-600 font-bold">5-7 ani</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="px-6 py-4 text-center text-blue-600 font-bold">Minimă</td>
            </tr>
            <tr>
              <td class="px-6 py-4 font-bold bg-slate-50">Preț</td>
              <td class="px-6 py-4 text-center text-blue-600 font-bold">Scăzut</td>
  ...
  },
  {
    ...
    contentHtml: `
      ...
      <div class="my-10 p-8 bg-blue-50 border-l-4 border-blue-500 rounded-r-2xl">
        ...
        <p class="text-blue-800 italic">Pornești de la A0, care prin definiție are exact 1 metru pătrat suprafață (841 x 1189 mm). Fiecare format următor (A1, A2, A3...) este jumătate din suprafața celui anterior. Deci A4 are 1/16 dintr-un metru pătrat, iar A6 are 1/64.</p>
      </div>
      ...
      <div class="overflow-x-auto my-8">
          <table class="min-w-full bg-white border border-slate-200 rounded-xl overflow-hidden shadow-sm">
              ...
              <tbody class="divide-y divide-slate-200">
                  ...
                  <tr>
                      <td class="px-6 py-4 font-bold text-slate-900 border-r bg-slate-50/50 text-blue-600">A3</td>
                      <td class="px-6 py-4 font-semibold text-blue-900">297 x 420</td>
                      <td class="px-6 py-4 font-semibold text-blue-900">1/8</td>
                      <td class="px-6 py-4 italic text-blue-600">Meniuri, pliante duble</td>
                  </tr>
                  <tr>
                      <td class="px-6 py-4 font-bold text-white border-r bg-blue-600">A4</td>
                      <td class="px-6 py-4 font-bold text-blue-900 bg-blue-50">210 x 297</td>
                      <td class="px-6 py-4 font-bold text-blue-900 bg-blue-50">1/16</td>
                      <td class="px-6 py-4 italic text-blue-700 font-medium">Standard birou, contracte</td>
                  </tr>
                  <tr>
  ...
  },
  {
    ...
    contentHtml: `
          ...
          <table class="min-w-full bg-white">
              <thead class="bg-slate-900 text-white">
                  <tr>
                      ...
                      <th class="px-6 py-4 text-center text-blue-400">Print UV (Anexa1)</th>
                  </tr>
              </thead>
              <tbody class="divide-y divide-slate-100">
                  <tr>
      ...
      <p>Nu tot ce circulă despre print e exact, dar diferența reală există și se simte la calitatea produsului final. La Anexa1.ro lucrăm cu tehnologie UV pentru materialele destinate interiorului și pentru majoritatea comenzilor outdoor. Verifică specificațiile în <a href="/configurator/banner">configuratorul nostru online</a> înainte de comandă.</p>
    `,
  },
  {
          ...
          <table class="min-w-full bg-white">
              ...
              <tbody class="divide-y divide-slate-100 text-sm">
                  <tr>
                      ...
                      <td class="px-6 py-4 text-center text-blue-600 font-bold">One Way Vision</td>
                  </tr>
                  <tr>
        ...
        <table class="min-w-full bg-white">
          <thead class="bg-slate-900 text-white">
            <tr>
              ...
              <th class="px-6 py-4 text-left font-bold">Recomandare Anexa1</th>
            </tr>
          </thead>
          <tbody class="divide-y divide-slate-100 text-sm">
            <tr>
            ...
            <tr>
              ...
              <td class="px-6 py-4 text-blue-600 font-bold">Alucobond 3mm sau Plexiglass, print UV direct</td>
            </tr>
          </tbody>
        </table>
      </div>
  ...
  },
  {
    ...
    contentHtml: `
      ...
      <p>Am livrat kituri de vizibilitate pentru proiecte PNRR, Start-Up Nation și Digitalizare, deci știm exact ce urmărește un monitor la vizită. Comandă cu încredere <a href="/shop/fonduri-europene">materialele tale de vizibilitate</a> de la Anexa1.ro și pregătește-te pentru control fără emoții.</p>
    `,
  },
  {
        ...
        <table class="min-w-full bg-white">
          ...
          <tbody class="divide-y divide-slate-100 text-sm">
            <tr>
              ...
              <td class="px-6 py-4 text-center text-blue-600 font-bold">3-4 săptămâni</td>
            </tr>
            <tr>
        ...
        <table class="min-w-full bg-white">
          ...
          <tbody class="divide-y divide-slate-100 text-sm">
            <tr>
              ...
              <td class="px-6 py-4 text-center text-blue-600 font-bold">Mare (1-4+ mp)</td>
              <td class="px-6 py-4 text-center text-blue-600 font-bold">Mică-medie (logo, text)</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="px-6 py-4 text-center text-blue-600 font-bold">Poate fi DIY</td>
            </tr>
          </tbody>
        </table>
      </div>
        ...
        <table class="min-w-full bg-white">
          ...
          <tbody class="divide-y divide-slate-100 text-sm">
            ...
            <tr>
              ...
              <td class="px-6 py-4 text-center text-blue-600 font-bold">Frontlit 510g</td>
              <td class="px-6 py-4 text-center text-blue-600 font-bold">Standard fixă</td>
              <td class="px-6 py-4 text-center text-blue-600 font-bold">Fără dată, mesaj evergreen</td>
            </tr>
            <tr>
...
const COUNTY_POSTS: BlogPost[] = JUDETE_DATA.map((j, index) => buildCountyPost(j, index, "Anexa1.ro", "Anexa1"));
