...
export type BrandKey = "shopprint" | "anexa1" | "euprint" | "prynt";
...
const BRAND_VOICES: Record<BrandKey, BrandVoice> = {
  ...
  anexa1: {
    heroOpeners: [
      "Afacerile din {localitate} aleg Anexa1 pentru {produs} — comandă azi, gata rapid.",
      "Producem {produs} pentru clienți din {localitate} și din județul {judet}, cu focus pe publicitate outdoor.",
      "Anexa1 echipează afacerile din {localitate} cu {produs} rezistent și vizibil de departe.",
    ],
    deliveryClosers: {
