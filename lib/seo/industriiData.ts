...
export const INDUSTRIE_DATA: IndustryData[] = [
    {
        ...
        longDescription: 'Sectorul HoReCa necesită materiale publicitare de înaltă calitate care să reziste la trafic intens și intemperii (pentru terase). Anexa1 oferă soluții complete, de la meniuri personalizate și note de plată, până la bannere de mari dimensiuni și decoruri de interior cu tapet personalizat.',
        benefits: [
    ...
    },
    {
        ...
        longDescription: 'Vizibilitatea este cheia în imobiliare. Un banner bine plasat sau un mesh pe o clădire în construcție poate atrage sute de potențiali clienți. Anexa1 produce bannere rezistente la vânt și soare, ideale pentru expunere pe termen lung.',
        benefits: [
    ...
    },
    {
        ...
        longDescription: 'Fie că participi la un târg internațional sau organizezi o lansare de produs, prezența ta trebuie să fie impecabilă. Anexa1 oferă sisteme retractabile portabile și printuri de mari dimensiuni cu montaj ușor.',
        benefits: [
    ...
    },
    {
        ...
        longDescription: 'Atrage clienții în magazin cu vitrine spectaculoase. Anexa1 oferă soluții de colantare integrală a vitrinelor, stickere promoționale temporare pentru reduceri și sisteme de afișaj indoor din Forex sau Carton Plume.',
        benefits: [
    ...
    },
    {
        ...
        longDescription: 'Instituțiile de învățământ au nevoie de materiale clare, colorate și durabile. De la bannere pentru zilele porților deschise, la panouri de orientare în campus, afișe motivaționale sau diplome premium – Anexa1 asigură calitate la prețuri accesibile pentru bugetele academice.',
        benefits: [
    ...
    },
    {
        ...
        longDescription: 'Un showroom auto bine branduit inspiră încredere și atrage cumpărători. Anexa1 oferă soluții complete de branding auto: de la wrapping parțial al mașinilor de serviciu, la bannere mari pentru fațadele showroom-urilor și stickere de preț pentru vehicule.',
        benefits: [
    ...
    },
    {
        ...
        longDescription: 'Brandingul unui club sportiv sau al unui eveniment de competiție trebuie să transmită energie și profesionalism. Anexa1 produce bannere de sponsorizare, tricouri și șepci personalizate, numere de concurs rezistente la transpirație și intemperii, panouri de afișaj pentru rezultate.',
        benefits: [
    ...
    },
    {
        ...
        longDescription: 'Un șantier activ este și un spațiu publicitar excelent. Anexa1 furnizează oricât de mari panouri de protecție/publicitate din mesh rezistent la vânt, indicatoare de siguranță conforme ISCIR și materiale de prezentare pentru viitorii cumpărători sau investitori.',
        benefits: [
    ...
    },
    {
        ...
        longDescription: 'În industria beauty, prima impresie este totul. Materialele tale de marketing trebuie să reflecte aceleași standarde de eleganță și rafinament pe care le oferi clienților. Anexa1 creează rollup-uri premium, pliante cu finisaje de lux (laminare soft-touch, folie UV) și carduri cadou care fac diferența.',
        benefits: [
    ...
    },
    {
        ...
        longDescription: 'Atractivitatea vizuală este crucială în vânzarea produselor alimentare. Anexa1 produce etichete alimentare certificate, bannere pentru promoții sezoniere, tablouri canvas apetisante pentru decorarea spațiului și meniuri din materiale rezistente la manipulare frecventă.',
        benefits: [
    ...
    },
    {
        ...
        longDescription: 'ONG-urile și instituțiile publice au nevoie de materiale de comunicare impactante, dar cu bugete adesea limitate. Anexa1 oferă prețuri speciale pentru organizații fără scop lucrativ și fonduri europene PNRR/AFIR, asigurând vizibilitate maximă cu costuri optimizate.',
        benefits: [
    ...
    },
    {
        ...
        longDescription: 'Industria turismului concurează vizual în fiecare punct de vânzare. Fie că ești o pensiune montană sau o agenție de turism națională, materialele de promovare trebuie să transpună experiența pe hârtie. Anexa1 produce pliante de călătorie, rollup-uri pentru târguri și bannere mari pentru locații.',
        benefits: [
    ...
    },
    {
        ...
        longDescription: 'Startup-urile și companiile tech au nevoie de un branding coerent și modern care să impresioneze investitorii și clienții. Anexa1 produce rollup-uri pentru conferințe, merchandise de echipă (tricouri, șepci, agende) și prezentări premium pentru pitch-uri.',
        benefits: [
    ...
    },
    {
        ...
        longDescription: 'Agricultura modernă are nevoie de identificare clară și branding. Anexa1 produce bannere mari pentru silozuri, panouri rezistente la intemperii pentru marcarea terenurilor și etichete durabile pentru produse agroalimentare.',
        benefits: [
    ...
    },
    {
        ...
        longDescription: 'Siguranța și organizarea sunt prioritare în mediul industrial. Anexa1 furnizează panouri rigide din PVC sau metal, marcaje reflectorizante pentru zone periculoase și instrucțiuni de utilizare a utilajelor rezistente la uleiuri și temperaturi.',
        benefits: [
    ...
    },
    {
        ...
        longDescription: 'Un magazin online are nevoie de o experiență de "unboxing" memorabilă. Anexa1 produce "thank you cards" personalizate, stickere cu logo pentru sigilarea cutiilor și flyere promoționale pentru retenția clienților.',
        benefits: [
    ...
    },
    {
        ...
        benefits: [
            ...
            'Livrare neutră (fără branding Anexa1 pe ambalaj)',
    ...
    },
    {
        ...
        longDescription: 'În campaniile electorale, viteza și vizibilitatea sunt lege. Anexa1 livrează volume uriașe de pliante, flyere și bannere stradale întrun timp record. Toate materialele sunt conforme cu legislația privind finanțarea campaniilor electorale.',
        benefits: [
