...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 30px 20px; text-align: center; border-radius: 10px 10px 0 0;">
    <h1 style="margin: 0; font-size: 28px;">📄 Oferta ta Anexa1.ro</h1>
  ...
  <div style="background: #f9f9f9; padding: 30px 20px; border-radius: 0 0 10px 10px;">
    ...
    <div style="margin-top: 30px; padding-top: 20px; border-top: 2px solid #eee; text-align: center; color: #999; font-size: 13px;">
      ...
      <p style="margin: 5px 0;">📧 <strong>Email:</strong> contact@anexa1.ro</p>
      <p style="margin: 5px 0;">🌐 <strong>Website:</strong> <a href="https://www.anexa1.ro" style="color: #667eea; text-decoration: none;">www.anexa1.ro</a></p>
      <p style="margin: 20px 0 5px 0; font-size: 12px; color: #bbb;">
        Acest email a fost generat automat de asistentul AI Anexa1.ro
      </p>
    </div>
  </div>
</body>
...
Echipa Anexa1.ro
  ...
  const result = await sendEmail({
    from: 'Anexa1.ro <contact@anexa1.ro>',
    to,
    subject: `📄 Oferta ta Anexa1.ro #${orderNo} (${total.toFixed(2)} RON)`,
    html: htmlContent,
    text: textContent,
  });
