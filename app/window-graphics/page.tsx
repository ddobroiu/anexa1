...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Transformă vitrina sau geamurile într-un spațiu publicitar cu folie perforată One Way Vision. Comandă online la Anexa1.ro!",
    images: [{
...
export default async function WindowGraphicsPage() {
  ...
  const url = `${process.env.NEXT_PUBLIC_SITE_URL || "https://www.anexa1.ro"}/window-graphics`;
