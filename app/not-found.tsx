            ...
            <div className="max-w-4xl w-full relative z-10 text-center">
                <div className="mb-8 relative inline-block">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                        <div className="bg-white dark:bg-slate-900 border-2 border-slate-200 dark:border-slate-800 p-8 rounded-[40px] shadow-2xl transform -rotate-2">
                            <Sparkles size={48} className="text-blue-600 mb-4 mx-auto animate-bounce" />
                ...
                <div className="mt-12">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 px-4">
                        <Link href="/configurator/banner" className="group bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-200 dark:border-slate-800 hover:border-blue-500 transition-all hover:shadow-xl hover:-translate-y-1">
                            <Printer className="text-blue-600 mb-3 group-hover:scale-110 transition-transform" />
                        ...
                        <Link href="/configurator/fonduri-eu" className="group bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-200 dark:border-slate-800 hover:border-blue-500 transition-all hover:shadow-xl hover:-translate-y-1">
                            <Sparkles className="text-blue-600 mb-3 group-hover:scale-110 transition-transform" />
