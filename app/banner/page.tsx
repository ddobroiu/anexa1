...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: "Bannere publicitare outdoor Anexa1.ro"
    }]
  }
};
...
export default async function BannerPage({ searchParams }: { searchParams: Promise<{ [key: string]: string | string[] | undefined }> }) {
  ...
  const url = `${process.env.NEXT_PUBLIC_SITE_URL || "https://www.anexa1.ro"}/banner`;
            ...
            <div className="space-y-6 max-w-3xl mx-auto">
              {[
                ...
                },
                {
                  ...
                  a: "Da! Finisarea standard ce include tivirea perimetrală și montarea capselor metalice la distanță de ~30cm este oferită GRATUIT pentru toate produsele Anexa1."
                },
                {
