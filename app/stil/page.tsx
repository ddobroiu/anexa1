...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.anexa1.ro/stil' }
};
                ...
                <div className="container mx-auto px-6 relative z-10">
                    <div className="max-w-4xl mx-auto">
                        <div className="inline-flex items-center gap-2 px-3 py-1 bg-slate-50 text-slate-400 rounded-full font-black text-[10px] uppercase tracking-widest mb-6 border border-slate-100 shadow-sm">
                            <Palette size={14} className="text-blue-500" /> CURATOR DESIGN VIZUAL
                        </div>
                        <h1 className="text-6xl md:text-9xl font-black text-slate-900 tracking-tighter leading-[0.8] mb-8 uppercase italic">
                            Alege Stilul <br /> <span className="text-blue-500 not-italic uppercase tracking-tighter">Care Te Definește.</span>
                        </h1>
            ...
            <div className="py-24 container mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        >
                            ...
                            <div className="absolute bottom-10 left-10 right-10 z-10">
                                <div className="flex items-center gap-2 mb-3">
                                    ...
                                    <span className="text-[10px] font-black uppercase text-blue-400 tracking-widest">COLECȚIA RECOMANDATĂ</span>
                                </div>
                                ...
                                <div className="w-16 h-16 rounded-full bg-white text-slate-950 flex items-center justify-center group-hover:bg-blue-500 group-hover:text-white transition-all shadow-xl">
                                    <ArrowRight size={24} />
                                </div>
                            </div>
                        </Link>
                    ...
                    <div className="bg-slate-50 rounded-[4rem] border-4 border-dashed border-slate-200 p-12 flex flex-col justify-center items-center text-center group h-[600px]">
                        <div className="w-20 h-20 rounded-3xl bg-white border border-slate-100 flex items-center justify-center text-slate-300 mb-8 group-hover:text-blue-500 group-hover:border-blue-500 group-hover:rotate-12 transition-all">
                            <Sparkles size={40} />
                        </div>
                        ...
                        <Link href="/" className="px-8 py-4 bg-slate-900 text-white rounded-2xl font-black text-xs uppercase tracking-[0.2em] hover:bg-blue-500 transition-all active:scale-95 shadow-xl">Lansează Configurator</Link>
                    </div>
                </div>
            </div>
        </div>
