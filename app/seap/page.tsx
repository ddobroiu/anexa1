...
export const metadata: Metadata = {
    ...
    keywords: ["SEAP", "SICAP", "achizitii publice", "anexa1 seap", "plata trezorerie", "e-factura", "catalog seap", "bannere seap", "semnalistica institutii"],
};
...
const SEAPFeatures = [
    ...
    },
    {
        ...
        description: "Un specialist Anexa1 vă stă la dispoziție pentru a vă ajuta cu specificațiile tehnice și configurarea pachetelor.",
        icon: MessageSquare,
        color: "text-teal-600",
        bg: "bg-teal-50"
    }
                            ...
                            <div className="space-y-8 relative z-10">
                                <div className="flex gap-6">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-slate-400">Alegeți produsele de pe Anexa1.ro sau solicitați o ofertă personalizată prin email la <span className="text-green-400 font-bold">contact@Anexa1.ro</span>.</p>
                                    </div>
                                </div>
                                <div className="flex gap-6">
                    ...
                    <div id="contact-seap" className="lg:col-span-1">
                        <div className="sticky top-32 p-10 bg-white rounded-[2.5rem] border border-slate-200 shadow-xl shadow-slate-200/50">
                            ...
                            <div className="space-y-6">
                                ...
                                <a href="mailto:contact@Anexa1.ro" className="flex items-center gap-5 p-6 rounded-2xl bg-slate-50 border border-slate-100 hover:border-green-400 transition-all group">
                                    ...
                                    <div>
                                        ...
                                        <span className="text-xl font-black text-slate-900 tracking-tight">contact@Anexa1.ro</span>
                                    </div>
                                </a>

                                <a href="https://wa.me/40750473111" className="flex items-center gap-5 p-6 rounded-2xl bg-blue-50 border border-blue-100 hover:border-blue-500 transition-all group">
                                    <div className="w-14 h-14 bg-white rounded-xl shadow-sm flex items-center justify-center text-blue-600 group-hover:scale-110 transition-transform">
                                        <MessageSquare className="w-7 h-7" />
                                    </div>
                                    <div>
                                        <span className="block text-xs font-bold text-blue-600/60 uppercase tracking-widest mb-1">WhatsApp de Urgență</span>
                    ...
                    <div className="prose prose-slate prose-lg max-w-none prose-headings:font-black prose-headings:uppercase prose-headings:tracking-tight prose-a:text-green-600 prose-strong:text-slate-900">
                        ...
                        <div className="p-10 bg-slate-50 rounded-[2rem] border border-slate-200 mt-12 mb-12 shadow-inner">
                            <h4 className="flex items-center gap-3 text-2xl font-black mb-4">
                                <TrendingUp className="text-green-600" /> Producător direct, nu intermediar
                            </h4>
                            <p>
                                Producem în atelier propriu panourile rigide, plăcuțele de sediu, semnalistica, bannerele și materialele tipărite cerute în mod uzual în <strong>achizițiile publice de print</strong>. Prețul afișat în configurator este prețul de producător, fără comisioane de intermediere, iar fiecare ofertă include specificațiile tehnice necesare la evaluarea ofertelor economice: material, grosime, tip de print, finisaj și sistem de prindere.
                            </p>
                        </div>
            ...
            <section className="py-32 bg-white text-center">
                <div className="container mx-auto px-4 max-w-4xl">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-6">
                        <a href="mailto:contact@Anexa1.ro" className="px-12 py-6 bg-slate-900 text-white rounded-2xl font-black text-xl hover:bg-slate-800 transition-all shadow-2xl shadow-slate-900/20 uppercase tracking-widest">
                            Trimite Email SEAP
                        </a>
