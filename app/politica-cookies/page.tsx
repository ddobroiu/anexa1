...
export const metadata = {
    ...
    description: "Află cum folosim cookies pe site-ul Anexa1.ro, inclusiv pentru Chat AI și WhatsApp, pentru o experiență optimă.",
};
            ...
            <div className="max-w-3xl mx-auto rounded-xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow p-8">
                ...
                <div className="grid md:grid-cols-2 gap-4 text-sm mb-4">
                    ...
                    <div>
                        ...
                        <p>Email: <a href="mailto:contact@Anexa1.ro" className="text-blue-600 underline">contact@Anexa1.ro</a><br />
                            Cookies: <a href="mailto:contact@Anexa1.ro" className="text-blue-600 underline">contact@Anexa1.ro</a><br />
                            <strong>ANSPDCP:</strong> <a href="https://dataprotection.ro" target="_blank" className="text-blue-600 underline">dataprotection.ro</a></p>
                    </div>
                </div>

                <p className="text-slate-600 dark:text-slate-400 mb-4">
                    Pentru detalii complete despre prelucrarea datelor personale, consultați <a href="/confidentialitate" className="text-blue-600 underline hover:text-blue-800 transition-colors">Politica de confidențialitate</a>.
                </p>
