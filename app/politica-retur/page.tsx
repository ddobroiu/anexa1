...
export const metadata = {
  title: "Politică de Retur și Garanție - Anexa1",
  description: "Află condițiile de retur și garanție pentru produsele Anexa1. Dreptul de retragere pentru produsele personalizate conform OUG 34/2014.",
};
      ...
      <div className="container mx-auto px-4 max-w-4xl relative z-10">
        <div className="text-center mb-16 lg:mb-20">
          <h1 className="text-4xl lg:text-6xl font-black text-slate-900 dark:text-white mb-6 tracking-tighter uppercase italic leading-none">
            Retur <span className="text-blue-600">&</span> Garanție
          </h1>
          <div className="h-1.5 w-24 bg-blue-600 mx-auto rounded-full shadow-lg mb-8"></div>
        ...
        <div className="bg-white dark:bg-slate-900 p-8 lg:p-16 rounded-[2.5rem] shadow-xl border border-slate-200 dark:border-slate-800 mb-12 relative overflow-hidden">
          ...
          ">
            <section>
              <h2 className="text-2xl lg:text-3xl border-l-4 border-blue-600 pl-6">01. Dreptul de Retragere</h2>
              <p>
              ...
              <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 list-none pl-0">
                  <li className="p-6 rounded-2xl bg-slate-50 dark:bg-slate-950/50 border border-slate-100 dark:border-slate-800">
                      <span className="text-blue-600 font-bold block mb-1">Stare Produs</span>
                      Trebuie să fie în ambalajul original, fără urme de utilizare.
                  </li>
                  <li className="p-6 rounded-2xl bg-slate-50 dark:bg-slate-950/50 border border-slate-100 dark:border-slate-800">
                      <span className="text-blue-600 font-bold block mb-1">Cumpărător</span>
                      Cheltuielile de transport pentru retur sunt suportate de dvs.
                  </li>
              </ul>
              <div className="not-prose mt-8 p-6 rounded-2xl bg-blue-50 dark:bg-blue-950/20 border border-blue-100 dark:border-blue-900/40">
                ...
                <a href="/retragere-contract" className="inline-flex items-center gap-2 px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-black text-sm uppercase tracking-widest transition-colors">
            ...
            <section id="cum-te-retragi">
              <h2 className="text-2xl lg:text-3xl border-l-4 border-blue-600 pl-6">02. Cum te retragi din contract</h2>
              <p>
              ...
              <ol>
                <li>
                  Deschide formularul <a href="/retragere-contract" className="text-blue-600 font-bold">„Retrage-te din contract”</a>. Îl găsești în subsolul
            ...
            <section>
              <h2 className="text-2xl lg:text-3xl border-l-4 border-blue-600 pl-6">03. Garanția de Calitate</h2>
              <p>
                Dacă produsul primit prezintă un defect de material, print sau asamblare, Anexa1 se angajează să refacă comanda gratuit.
              </p>
              <p> Vă rugăm să ne înștiințați în scris, la <a href={`mailto:${siteConfig.business.contact.email}`} className="text-blue-600 font-bold">{siteConfig.business.contact.email}</a>, în primele 48 de ore de la primirea coletului, atașând dovezi foto/video ale defectului semnalat.</p>
            </section>

            <section>
              <h2 className="text-2xl lg:text-3xl border-l-4 border-blue-600 pl-6">04. Anularea Comenzii</h2>
              <p>
