            ...
            <div className="container mx-auto px-4 !max-w-7xl">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center mb-24">
                    <div className="space-y-6">
                        <span className="inline-block px-4 py-1.5 rounded-full bg-blue-100 text-blue-700 font-bold text-xs uppercase tracking-widest">
                            Anexa1.ro
                        </span>
                        <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-slate-900 leading-tight tracking-tighter">
                            Nu suntem doar o <span className="text-blue-500">tipografie.</span>
                        </h1>
                        ...
                        <div className="flex gap-4 pt-4 text-blue-600 font-bold">
                    ...
                    <div className="relative aspect-square lg:aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl bg-slate-900 border border-slate-200">
                        <Image 
                            ...
                            alt="Echipa și Tehnologia Anexa1" 
                            fill 
                            priority 
                            className="object-cover mix-blend-overlay opacity-80"
                        />
                        <div className="absolute inset-0 bg-gradient-to-tr from-slate-900/40 to-blue-900/40"></div>
                ...
                <div className="bg-white rounded-3xl p-8 md:p-16 shadow-lg border border-slate-100 mb-24 relative overflow-hidden">
                    ...
                    <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-blue-50 rounded-full blur-3xl -mr-48 -mt-48 pointer-events-none"></div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-16 relative z-10">
                        <div>
                            ...
                            <div className="prose prose-slate prose-p:leading-relaxed text-slate-600">
                                <p>
                                    Când am fondat Anexa1, am observat o problemă majoră în industria tipografică: timpii uriași de așteptare pentru cererile de ofertă și opacitatea prețurilor. Misiunea noastră este să aducem o **transparență absolută** și eficiență maximă procesului de print B2B și B2C din România.
                                </p>
                                <p>
                        ...
                        <div>
                            ...
                            <div className="prose prose-slate prose-p:leading-relaxed text-slate-600">
                                ...
                                <ul className="space-y-2 mt-4 marker:text-blue-500 font-medium">
                ...
                <div className="text-center mb-16">
                    <h2 className="text-3xl md:text-5xl font-black text-slate-900 mb-6 tracking-tighter">
                        Oamenii din spatele <span className="text-blue-500">mașinilor</span>
                    </h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24">
                    {[
                        { 
                            ...
                            i: <Zap className="text-blue-500" size={32} />
                        },
                        { 
                        ...
                        <div key={idx} className="bg-white p-8 rounded-3xl border border-slate-100 hover:shadow-xl hover:border-blue-500 transition-all group">
                            <div className="w-16 h-16 bg-slate-50 flex items-center justify-center rounded-2xl mb-6 group-hover:bg-blue-50 transition-colors">
                                {v.i}
                            </div>
                ...
                <div className="bg-slate-900 rounded-[3rem] p-12 md:p-20 text-center relative overflow-hidden shadow-2xl">
                    ...
                    <div className="relative z-10 max-w-2xl mx-auto">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <Link href="/configuratoare" className="px-8 py-4 bg-blue-500 hover:bg-blue-400 text-slate-950 font-black rounded-xl transition-all active:scale-95 shadow-lg shadow-blue-500/20">
