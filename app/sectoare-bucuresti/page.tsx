    ...
    return (
        <div className="min-h-screen bg-white selection:bg-blue-500 selection:text-white">
            ...
            <div className="pt-32 pb-24 bg-slate-900 text-white relative overflow-hidden rounded-b-[4rem]">
                ...
                <div className="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-l from-blue-500/10 to-transparent blur-3xl pointer-events-none"></div>
                ...
                <div className="container mx-auto px-6 relative z-10">
                    <div className="max-w-3xl">
                        ...
                        <h1 className="text-5xl md:text-8xl font-black tracking-tighter leading-[0.8] mb-8">
                            Bucureștiul <br /> <span className="text-blue-500 italic">Printează cu Noi.</span>
                        </h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {sectoare.map((s) => (
                        <Link 
                            ...
                            className="group bg-white rounded-[2.5rem] overflow-hidden border border-slate-100 shadow-xl hover:shadow-2xl hover:border-blue-200 transition-all duration-500 flex flex-col h-full"
                        >
                            ...
                            <div className="p-10">
                                <h3 className="text-3xl font-black text-slate-900 group-hover:text-blue-600 transition-colors mb-4">{s.name}</h3>
                                ...
                                <div className="flex items-center justify-between pt-6 border-t border-slate-50">
                                    <span className="text-xs font-black uppercase text-blue-500 tracking-widest">Vezi Configurări &rarr;</span>
                                    <div className="w-10 h-10 rounded-full bg-slate-100 text-slate-400 flex items-center justify-center group-hover:bg-blue-500 group-hover:text-white transition-colors">
                                        <ArrowRight size={18} />
                                    </div>
                                </div>
                            </div>
            ...
            <section className="py-32 bg-slate-50">
                <div className="container mx-auto px-6">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                        <div>
                            <h2 className="text-4xl font-black text-slate-900 tracking-tighter uppercase mb-10 leading-tight">Avantajul Anexa1 <br /> în București</h2>
                            <div className="space-y-12">
                                {[
                                    ...
                                    <div key={i} className="flex gap-6 group">
                                        <div className="w-16 h-16 bg-white border border-slate-200 text-blue-500 rounded-2xl flex items-center justify-center shrink-0 group-hover:bg-blue-500 group-hover:text-white transition-all shadow-sm">
                        ...
                        <div className="relative rounded-[3rem] overflow-hidden aspect-square rotate-3 border-8 border-white shadow-2xl">
                             <Image src="/products/banner/banner-1.webp" alt="Anexa1 Bucharest Hub" fill className="object-cover" />
