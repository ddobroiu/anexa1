...
export default async function Page({ searchParams }: { searchParams: Promise<{ [key: string]: string | string[] | undefined }> }) {
  ...
  const url = `${process.env.NEXT_PUBLIC_SITE_URL || "https://www.anexa1.ro"}/tapet`;
        ...
        <div className="container mx-auto px-4 max-w-5xl relative z-10">
          <div className="text-center mb-16 lg:mb-20">
            ...
            <p className="text-xl text-slate-400 max-w-3xl mx-auto font-medium italic leading-relaxed">
              Transformă orice încăpere cu <strong className="text-green-400">tapet personalizat pe dimensiunile peretelui tău</strong>. La Anexa1 folosim tehnologie de print ecologică, sigură pentru locuințe, grădinițe sau birouri.
            </p>
          </div>
