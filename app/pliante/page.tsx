...
export default async function Page({ searchParams }: { searchParams: Promise<{ [key: string]: string | string[] | undefined }> }) {
  ...
  const url = `${process.env.NEXT_PUBLIC_SITE_URL || "https://www.anexa1.ro"}/pliante`;
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              Chiar și în era digitală, <strong className="text-orange-600">flyerele și pliantele rămân un instrument esențial</strong> pentru marketing-ul local. La Anexa1 printăm materiale publicitare care atrag atenția prin claritate și culori vii.
            </p>
          </div>
