    ...
    return (
      <div className="flex min-h-screen items-center justify-center">
        <div className="w-full max-w-md rounded-3xl border border-slate-200 bg-slate-50 p-8 text-center shadow-2xl backdrop-blur-xl">
          ...
          <a
            href="/admin/login"
            className="mt-6 inline-flex w-full items-center justify-center rounded-xl bg-blue-600 px-4 py-2.5 text-sm font-semibold text-slate-900 shadow-lg shadow-blue-900/20 transition-all hover:bg-blue-500"
          >
            Mergi la Login
          </a>
        </div>
      ...
      <div className="grid gap-3 sm:gap-4 grid-cols-2 xl:grid-cols-4">
        ...
        <div className="relative overflow-hidden rounded-xl sm:rounded-2xl border border-slate-200 bg-white p-4 sm:p-5 shadow-sm hover:bg-slate-50 transition-colors group touch-manipulation">
          <div className="flex items-start justify-between">
            ...
            <div className="p-1.5 sm:p-2 rounded-lg bg-blue-500/10 text-blue-600 group-hover:bg-blue-500/20 transition-colors">
              <ShoppingBag size={18} className="sm:w-5 sm:h-5" />
            </div>
          </div>
          <div className="mt-3 sm:mt-4 flex items-center gap-2 text-xs">
            <span className="flex items-center text-blue-600 font-medium bg-blue-500/10 px-1.5 py-0.5 rounded">
              +{totals.last24h}
            </span>
