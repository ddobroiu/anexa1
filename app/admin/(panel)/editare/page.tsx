                ...
                <div className="lg:col-span-4 space-y-6">
                        ...
                        <div className="space-y-5">
                            ...
                            <div className="bg-slate-50 p-4 border border-slate-100 rounded-xl space-y-4 mb-2">
                                <div>
                                    ...
                                    <input 
                                        ...
                                        className="w-full bg-white border border-slate-200 rounded-lg px-3 py-2 text-sm text-slate-900 font-bold focus:ring-2 focus:ring-blue-500 outline-none placeholder-slate-300" 
                                        value={orderName} 
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <select 
                                            className="w-full bg-white border border-slate-200 rounded-lg px-3 py-2 text-sm text-slate-900 font-bold focus:ring-2 focus:ring-blue-500 outline-none"
                            ...
                            <div>
                                ...
                                <label className="flex flex-col items-center justify-center w-full h-24 border-2 border-dashed border-blue-300 rounded-xl cursor-pointer bg-blue-50 hover:bg-blue-100 transition-colors">
                                    <div className="flex flex-col items-center justify-center pt-2">
                                        ...
                                        <p className="text-xs font-semibold text-blue-700">Apasă pentru upload</p>
                                        {imageName && <p className="text-[10px] text-blue-600 font-medium px-2 truncate max-w-full">{imageName}</p>}
                                    </div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input 
                                        type="number" 
                                        className="w-full bg-slate-50 border border-slate-200 rounded-lg px-3 py-2 text-sm text-slate-900 font-bold focus:ring-2 focus:ring-blue-500 outline-none" 
                                        value={widthCm} 
                            ...
                            {imageSrc && (
                                <div className="pt-4 border-t border-slate-100">
                                    <label className="block text-xs font-bold text-slate-700 mb-2 flex justify-between">
                                        ...
                                        <span className="text-blue-600">{(imgPos.scale * 100).toFixed(0)}%</span>
                                    </label>
                                    <input 
                                        type="range"
                                        min="0.1" 
                    ...
                    {(imageSrc || texts.length > 0) && (
                        <button
                            ...
                            className="w-full flex items-center justify-center gap-3 bg-slate-900 text-slate-900 font-black py-4 rounded-xl hover:bg-blue-600 shadow-xl shadow-slate-900/10 transition-all active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
