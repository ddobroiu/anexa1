...
export async function generateMetadata({ params }: PageProps) {
    ...
    return {
        title: `${post.title} | Noutăți Anexa1.ro`,
        ...
        openGraph: {
            ...
            authors: [post.author || "Echipa Anexa1"],
            images: post.hero ? [{ url: post.hero, width: 1200, height: 630, alt: post.title }] : [{ url: "/logo-anexa1_1.png.webp", width: 1200, height: 630, alt: "Anexa1 Logo" }],
        },
        twitter: {
            card: "summary_large_image",
            title: post.title,
            description: post.description,
            images: post.hero ? [post.hero] : ["/logo-anexa1_1.png.webp"],
        }
    };
}
    ...
    return (
        <main className="min-h-screen pt-32 pb-24 bg-white">
            ...
            <ArticleSchema
                ...
                authorName={post.author || "Echipa Anexa1"}
                image={post.hero || "/logo-anexa1_1.png.webp"}
            ...
            <div className="container mx-auto px-6 !max-w-4xl">
                ...
                <div className="mb-12">
                    <Link 
                        href="/noutati" 
                        className="inline-flex items-center gap-2 text-sm font-black text-slate-400 hover:text-blue-600 transition-all group"
                    >
                ...
                <article>
                    ...
                    <header className="mb-12">
                        <div className="flex flex-wrap gap-2 mb-6">
                            {post.tags.map((tag) => (
                                <span key={tag} className="text-[10px] font-black uppercase tracking-widest text-blue-600 bg-blue-50 px-3 py-1.5 rounded-full border border-blue-100">
                                    {tag}
                                </span>
                            ))}
                        </div>
                        ...
                        <div className="flex flex-wrap items-center gap-6 text-sm text-slate-500 py-6 border-y border-slate-100">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="font-bold text-slate-900">{post.author || "Echipa Anexa1"}</span>
                            </div>
                            <div className="flex items-center gap-2">
                    ...
                    <div className="mt-20 p-12 md:p-16 bg-gradient-to-br from-slate-900 to-slate-950 rounded-[3rem] text-white relative overflow-hidden group border border-slate-800 shadow-2xl">
                        <div className="absolute top-0 right-0 w-80 h-80 bg-blue-500/10 rounded-full blur-[100px] -mr-40 -mt-40 pointer-events-none group-hover:bg-blue-500/15 transition-colors duration-700"></div>
                        ...
                        <div className="relative z-10 text-center">
                            ...
                            <Link href="/shop" className="text-white/50 hover:text-blue-400 font-bold transition-colors">
                    ...
                    <div className="mt-20 pt-12 border-t border-slate-100 flex flex-col md:flex-row items-center justify-between gap-8 bg-slate-50/50 p-8 rounded-[2rem]">
                        ...
                        <div className="flex gap-4">
                            <button className="flex items-center gap-2 px-6 py-3 bg-white text-slate-900 border border-slate-200 rounded-2xl font-black hover:bg-blue-50 hover:border-blue-200 hover:text-blue-600 transition-all shadow-sm">
                                <Share2 size={18} />
