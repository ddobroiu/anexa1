...
export const metadata = {
    ...
    keywords: ['noutati print', 'articole seo', 'dimensiuni hartie', 'ghid print a4', 'anexa1 noutati'],
    alternates: {
        canonical: '/noutati',
    },
    openGraph: {
        ...
        <main className="min-h-screen pt-32 pb-20 bg-slate-50">
            ...
            <section className="container mx-auto px-6 mb-16">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <h1 className="text-4xl md:text-6xl font-black text-slate-900 mb-6 tracking-tight">
                        Centrul de <span className="text-blue-600">Cunoaștere</span> Anexa1
                    </h1>
                        ...
                        >
                            ...
                            <Link href={`/noutati/${post.slug}`} className="block relative h-64 overflow-hidden">
                                {post.hero ? (
                                    ...
                                    <div className="w-full h-full bg-gradient-to-br from-slate-900 via-slate-800 to-blue-900 flex items-center justify-center p-8 text-center relative overflow-hidden">
            ...
            <section className="container mx-auto px-6 mt-20 !max-w-5xl">
                <div className="bg-slate-900 rounded-[3rem] p-12 md:p-16 text-center relative overflow-hidden shadow-2xl">
                    ...
                    <Link 
                        href="/contact" 
                        className="inline-flex items-center gap-3 bg-blue-500 hover:bg-blue-400 text-white font-black px-10 py-5 rounded-2xl transition-all hover:scale-105 active:scale-95 shadow-xl shadow-blue-500/20 relative z-10"
                    >
                        Contactează-ne acum
                        <ArrowRight size={20} />
                    </Link>
