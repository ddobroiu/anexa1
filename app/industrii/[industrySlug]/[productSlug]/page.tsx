...
export async function generateMetadata({ params }: { params: Promise<{ industrySlug: string, productSlug: string }> }): Promise<Metadata> {
    ...
    const title = `${prod.name} pentru ${ind.name.split(' (')[0]} | Anexa1`;
    ...
    return {
        title,
        description,
        alternates: { canonical: `https://Anexa1.ro/industrii/${ind.slug}/${productSlug}` }
    };
}
            ...
            <div className="pt-24 pb-12 border-b border-slate-100">
                <div className="container mx-auto px-6">
                    <nav className="text-[10px] font-black text-slate-400 mb-6 flex gap-3 items-center uppercase tracking-widest">
                        <Link href="/industrii" className="hover:text-blue-600">Industrii</Link> 
                        <span>/</span>
                        <Link href={`/industrii/${ind.slug}`} className="hover:text-blue-600">{industryName}</Link> 
                        <span>/</span>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div>
                            <h1 className="text-4xl md:text-7xl font-black text-slate-900 mb-6 tracking-tighter leading-[0.9]">
                                {productName} <br />
                                <span className="text-blue-500 italic">pentru {industryName}</span>
                            </h1>
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                <Link 
                                    href={prod.url} 
                                    className="bg-slate-900 text-white px-10 py-5 rounded-2xl font-black text-lg hover:bg-blue-600 transition-all uppercase tracking-widest flex items-center justify-center gap-3 shadow-xl"
                                >
                                    Configurează Acum
                                    <ArrowRight size={20} />
                                </Link>
                                <a 
                                    ...
                                    className="bg-blue-500 text-white px-10 py-5 rounded-2xl font-black text-lg hover:bg-blue-600 transition-all uppercase tracking-widest flex items-center justify-center gap-3 shadow-lg"
                                >
            ...
            <section className="py-24 bg-slate-50">
                <div className="container mx-auto px-6">
                    <div className="text-center mb-16">
                        <p className="text-blue-600 font-black uppercase tracking-widest text-xs mb-4 underline decoration-blue-200 decoration-4 underline-offset-4">De ce Anexa1?</p>
                        <h2 className="text-3xl md:text-5xl font-black text-slate-900 tracking-tighter uppercase leading-none">Alegerea Inteligentă pentru <br/> <span className="text-blue-500 italic">{industryName}</span></h2>
                    </div>
                ...
                <div className="container mx-auto px-6">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                        <div className="space-y-8">
                            ...
                            <h2 className="text-4xl font-black text-slate-900 tracking-tighter uppercase leading-[0.8]">Print de înaltă <br/> <span className="text-blue-500">rezoluție 1440 DPI.</span></h2>
                        ...
                        <div className="bg-slate-900 rounded-[3rem] p-12 text-white relative overflow-hidden group">
                           ...
                           <Link href="/contact" className="inline-block bg-white text-slate-900 px-8 py-4 rounded-xl font-black uppercase tracking-widest hover:bg-blue-500 hover:text-white transition-all shadow-lg">
