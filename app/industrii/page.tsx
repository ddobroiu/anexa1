...
const INDUSTRY_ACCENTS: Record<string, { bg: string; text: string; border: string; glow: string }> = {
    ...
    'fonduri-europene': { bg: 'bg-blue-50',  text: 'text-blue-600', border: 'border-blue-200', glow: 'shadow-blue-500/10' },
...
export default function IndustriiPage() {
    ...
    return (
        <div className="min-h-screen bg-[#fafafb] selection:bg-blue-500 selection:text-white">
            {/* STUNNING HERO */}
            <div className="pt-32 pb-24 bg-white border-b border-slate-100 relative overflow-hidden">
                {/* Visual elements */}
                <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-blue-500/5 blur-[120px] rounded-full -mr-48 -mt-48 animate-pulse" />
                ...
                <div className="container mx-auto px-4 relative z-10 text-center lg:text-left">
                    <div className="flex flex-col lg:flex-row gap-12 items-center">
                        <div className="flex-1 max-w-4xl mx-auto lg:mx-0">
                            <div className="inline-flex items-center gap-2 px-3 py-1 bg-blue-50 rounded-full text-blue-600 font-black text-[10px] uppercase tracking-[0.2em] mb-6 border border-blue-100">
                            ...
                            <h1 className="text-5xl md:text-8xl font-black text-slate-900 tracking-tighter leading-[0.9] mb-8 uppercase">
                                SOLUȚII DE PRINT <br /> 
                                <span className="text-blue-500 italic">PENTRU ORICE DOMENIU.</span>
                            </h1>
                ...
                <div className="container mx-auto px-4 flex flex-col md:flex-row gap-6 items-center justify-between">
                    ...
                    <div className="relative w-full md:max-w-md group">
                        ...
                        <input 
                            ...
                            className="w-full bg-white border-2 border-slate-100 hover:border-slate-200 focus:border-blue-500 rounded-2xl py-4 pl-14 pr-6 font-bold text-slate-900 outline-none transition-all shadow-sm"
                        />
                    </div>
                ...
                {filteredIndustries.length > 0 ? (
                        ...
                        {filteredIndustries.map((ind) => {
                            ...
                            return (
                                <Link
                                    ...
                                    className={`group bg-white rounded-[2.5rem] border border-slate-100 shadow-sm hover:shadow-2xl ${accent.glow} hover:border-blue-200 hover:-translate-y-2 transition-all duration-500 flex flex-col h-full overflow-hidden`}
                                >
                                    {/* Image Wrapper */}
                                    ...
                                    <div className="p-8 flex flex-col flex-1">
                                        <h3 className="text-xl font-black text-slate-800 group-hover:text-blue-600 transition-colors mb-4 uppercase tracking-tighter leading-tight italic">
                                            {ind.name.split(' (')[0]}
                                        </h3>
                                        ...
                                        <div className="flex items-center justify-between pt-6 border-t border-slate-50">
                                            ...
                                            <div className="w-10 h-10 rounded-2xl bg-slate-50 text-slate-400 flex items-center justify-center group-hover:bg-blue-500 group-hover:text-white transition-all duration-500 shadow-sm">
                                                <ArrowRight size={18} />
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div className="text-center py-40">
                        ...
                        <button 
                            ...
                            className="mt-8 px-8 py-3 bg-slate-900 text-white rounded-xl font-black text-xs uppercase tracking-widest hover:bg-blue-500 transition-colors"
                        >
            ...
            <div className="container mx-auto px-4 pb-20">
                <div className="bg-slate-950 rounded-[4rem] p-12 md:p-24 relative overflow-hidden group">
                    <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-blue-500/10 blur-[160px] rounded-full -mr-96 -mt-96" />
                    
                    <div className="max-w-4xl relative z-10">
                        <p className="text-blue-400 font-black uppercase tracking-[0.2em] text-xs mb-6">Proiecte Strategice</p>
                        <h2 className="text-4xl md:text-7xl font-black text-white leading-[0.95] tracking-tighter mb-10 uppercase">
                            ...
                            <span className="text-blue-500 italic">CREĂM SOLUȚII CUSTOM.</span>
                        </h2>
                        ...
                        <div className="flex flex-col sm:flex-row gap-6">
                            <Link href="/contact" className="px-12 py-6 bg-blue-500 text-white rounded-2xl font-black text-xl hover:bg-blue-400 transition-all shadow-xl shadow-blue-500/20 active:scale-95 text-center">
