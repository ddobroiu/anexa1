...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: "Rollup banner retractabil Anexa1.ro"
    }],
    type: "website",
  },
};
...
export default async function RollupPage() {
  ...
  const url = `${process.env.NEXT_PUBLIC_SITE_URL || "https://www.anexa1.ro"}/rollup`;
        ...
        <div className="container mx-auto px-4 max-w-5xl relative z-10">
          <div className="text-center mb-16 lg:mb-20">
            ...
            <p className="text-xl text-slate-400 max-w-3xl mx-auto font-medium italic leading-relaxed">
              Soluția ideală pentru conferințe, recepții, standuri expoziționale sau puncte de vânzare. Ușor de transportat, gata de expunere în mai puțin de <strong className="text-green-400">30 de secunde</strong>. Calitate de top, sistem durabil integrat cu casetă de aluminiu și print HD la Anexa1.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-start mb-24">
            <div className="space-y-8">
              <h3 className="text-2xl font-black text-white border-b-2 border-green-500 pb-4 inline-block uppercase italic tracking-widest">De ce Anexa1?</h3>
