...
export default async function SepciPage({ searchParams }: Props) {
    ...
    const url = `${process.env.NEXT_PUBLIC_SITE_URL || "https://www.Anexa1.ro"}/sepci`;
                ...
                <div className="container mx-auto px-4 max-w-5xl">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                            La <strong className="text-blue-600">Anexa1.ro</strong>, realizăm șepci personalizate folosind tipar DTF de înaltă calitate, care rezistă excelent în timp, cu materiale rezistente și culori vibrante.
                        </p>
                    </div>
                </div>
            </section>
