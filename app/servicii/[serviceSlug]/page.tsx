...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
    ...
    const description = `${service.description} Alege calitatea Anexa1 pentru finisaje de înaltă precizie: ${service.name.toLowerCase()}. Producător direct, rezultate impecabile.`;

    return {
        title,
        description,
        alternates: {
            canonical: `https://www.anexa1.ro/servicii/${serviceSlug}`
        },
        openGraph: {
            title,
            description,
