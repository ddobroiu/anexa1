...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.anexa1.ro/servicii' }
};

export default function ServiciiIndex() {
    return (
        <div className="min-h-screen bg-[#fafbfc] selection:bg-blue-500 selection:text-white">
            {/* Hero */}
            <div className="pt-32 pb-24 bg-white border-b border-slate-100 relative overflow-hidden">
                <div className="absolute top-0 right-0 w-1/3 h-full bg-blue-500/5 blur-[120px] rounded-full pointer-events-none" />
                
                <div className="container mx-auto px-6 relative z-10 text-center lg:text-left">
                    <div className="max-w-4xl mx-auto lg:mx-0">
                        <div className="inline-flex items-center gap-2 px-3 py-1 bg-blue-50 text-blue-600 rounded-lg font-black text-[10px] uppercase tracking-widest mb-6 border border-blue-100 italic">
                        ...
                        <h1 className="text-5xl md:text-8xl font-black text-slate-900 tracking-tighter leading-[0.9] mb-8 uppercase italic">
                            Finisaje de <br /> <span className="text-blue-500 not-italic uppercase">Înaltă Precizie.</span>
                        </h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {SERVICII_DATA.map((srv) => (
                        <Link
                            ...
                            className="group bg-white rounded-[3rem] border border-slate-100 p-10 hover:shadow-2xl hover:border-blue-200 transition-all duration-500 hover:-translate-y-2 flex flex-col items-center text-center relative overflow-hidden"
                        >
                            <div className="absolute top-0 left-0 w-1 h-full bg-blue-500 group-hover:w-2 transition-all" />
                            
                            <div className="w-20 h-20 rounded-2xl bg-slate-50 flex items-center justify-center text-blue-500 mb-8 border border-slate-50 group-hover:bg-blue-500 group-hover:text-white transition-all shadow-sm group-hover:rotate-6">
                                <Settings size={36} strokeWidth={2.5} />
                            </div>
                            
                            <h3 className="text-2xl font-black text-slate-900 group-hover:text-blue-600 transition-colors mb-4 uppercase tracking-tighter italic">
                                {srv.name.split(' (')[0]}
                            </h3>
                            ...
                            <div className="flex items-center gap-2 px-8 py-3 bg-slate-900 text-white rounded-xl font-black text-xs uppercase tracking-widest group-hover:bg-blue-500 transition-all active:scale-95 shadow-xl shadow-slate-950/20 group-hover:shadow-blue-500/30">
            ...
            <section className="py-32 bg-slate-900 text-white mx-4 md:mx-6 rounded-[4rem] mb-20 overflow-hidden relative">
                <div className="absolute top-0 left-0 w-full h-full opacity-10">
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-blue-500 rounded-full blur-[160px]" />
                </div>
                <div className="container mx-auto px-6 relative z-10 text-center">
                    <h2 className="text-4xl md:text-7xl font-black tracking-tighter uppercase mb-6 italic leading-none">
                        GATA PENTRU <br /> <span className="text-blue-500 not-italic">MONTAJ IMEDIAT.</span>
                    </h2>
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-4">
                        <Link href="/" className="px-10 py-5 bg-blue-500 text-white rounded-2xl font-black text-lg hover:bg-blue-400 transition-all shadow-xl shadow-blue-500/20 uppercase italic tracking-tighter">
