...
export const metadata: Metadata = {
    title: 'Panouri Alucobond (Dibond) pentru Fațadă și Firmă Permanentă | Anexa1',
    ...
    keywords: ['alucobond personalizat', 'dibond firma', 'panou aluminiu fatada', 'firma exterior permanenta', 'panou compozit aluminiu', 'anexa1'],
    alternates: {
        ...
        <Suspense fallback={<div className="min-h-screen flex items-center justify-center">Se încarcă configuratorul Alucobond...</div>}>
            <div className="pt-20">
                ...
                <ProductSchema
                    ...
                    description="Panou compozit din aluminiu, cel mai durabil material rigid din gama Anexa1, pentru firme de fațadă și semnalistică permanentă de exterior."
                    ...
                    <div className="container mx-auto px-4 max-w-5xl">
                        <div className="text-center mb-12">
                            ...
                            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                                Panoul compozit din aluminiu (Alucobond/Dibond) e <strong className="text-blue-600">cel mai durabil material rigid</strong> din gama noastră — alegerea potrivită când placa rămâne montată pe fațadă ani de zile, nu doar câteva luni.
                            </p>
                        </div>
