...
export const metadata: Metadata = {
    title: 'Panouri din Carton pentru Semnalistică Temporară de Interior | Anexa1',
    ...
    keywords: ['carton personalizat', 'carton ondulat', 'carton fagure honeycomb', 'display carton eveniment', 'panou carton indoor', 'anexa1'],
    alternates: {
                    ...
                    <div className="container mx-auto px-4 max-w-5xl">
                        <div className="text-center mb-12">
                            ...
                            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                                Panourile din carton ondulat sau fagure (honeycomb) sunt <strong className="text-blue-600">cea mai ieftină opțiune rigidă</strong> din gama noastră — potrivite pentru display-uri de eveniment și semnalistică de interior pe termen scurt.
                            </p>
                        </div>
