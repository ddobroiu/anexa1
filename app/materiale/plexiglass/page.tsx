...
export const metadata: Metadata = {
    title: 'Plexiglas Personalizat pentru Firme Indoor și Display-uri Premium | Anexa1',
    ...
    keywords: ['plexiglas personalizat', 'placi plexiglas firma', 'sticla acrilica showroom', 'print uv plexiglas', 'meniu plexiglas', 'anexa1'],
    alternates: {
                    ...
                    <div className="container mx-auto px-4 max-w-5xl">
                        <div className="text-center mb-12">
                            ...
                            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                                Plăcile de plexiglas (sticlă acrilică) oferă un <strong className="text-blue-600">aspect premium de interior</strong> — firme indoor discrete, meniuri de restaurant și display-uri de showroom, cu debitare CNC la orice formă.
                            </p>
                        </div>
