...
export const metadata: Metadata = {
    title: 'PVC Forex Personalizat pentru Panouri de Firmă Mid-Range | Anexa1',
    ...
    keywords: ['pvc forex', 'panouri firma magazin', 'pvc expandat semnalistica', 'placi pvc rigide', 'forex outdoor', 'anexa1'],
    alternates: {
                    ...
                    <div className="container mx-auto px-4 max-w-5xl">
                        <div className="text-center mb-12">
                            ...
                            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                                Placa din PVC expandat (Forex) stă <strong className="text-blue-600">exact între polipropilenă și Alucobond</strong> ca durabilitate și preț — soluția cea mai comună pentru firme de magazin și semnalistică outdoor sau indoor.
                            </p>
                        </div>
