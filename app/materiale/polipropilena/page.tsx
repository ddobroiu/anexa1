...
export const metadata: Metadata = {
    title: 'Panouri Polipropilenă Celulară (Akyplac) pentru Imobiliare și Șantier | Anexa1',
    ...
    keywords: ['polipropilena celulara', 'akyplac', 'panouri imobiliare', 'panouri santier', 'panou de vanzare', 'anexa1'],
};
                    ...
                    <div className="container mx-auto px-4 max-w-5xl">
                        <div className="text-center mb-12">
                            ...
                            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                                Polipropilena celulară (Akyplac) e <strong className="text-blue-600">ușoară, rezistentă la apă</strong> și mult mai accesibilă decât materialele rigide premium — alegerea potrivită când ai nevoie de multe panouri, la un cost controlat.
                            </p>
                        </div>
