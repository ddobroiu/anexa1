...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
    ...
    const description = `Comandă ${parsed.productName} la dimensiunea fixă de ${parsed.w}x${parsed.h} cm. Producător direct, preț calculat instant, print HD rezistent UV și livrare rapidă în 24-48h. Personalizează acum formatul ${parsed.w}x${parsed.h} cm pe Anexa1.ro!`;
