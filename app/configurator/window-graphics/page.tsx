...
export const metadata: Metadata = {
    title: 'Window Graphics pentru Vitrine - Autocolant Perforat One-Way - Anexa1',
    ...
    keywords: ['window graphics', 'autocolant perforat vitrina', 'one way vision', 'folie geam magazin', 'vitrofanie', 'anexa1'],
    alternates: {
                ...
                <FAQSchema
                    faqs={[
                        ...
                        },
                        {
                            ...
                            answer: "Pentru aplicări la vitrine unde se face curățenie agresivă periodic, se poate lamină folia Window Graphics folosind o folie optică pur-transparentă care sigilează micro-găurile ca să nu intre apa/murdăria fix acolo, dar în mod implicit standard, materialul ne-laminat tipărit cu cernelurile de la Anexa1 oferă un contrast natural imbatabil!"
                        },
                        {
