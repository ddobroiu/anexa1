...
export const metadata: Metadata = {
    title: 'Panouri de Vizibilitate Fonduri Europene - Conforme Manual de Identitate Vizuală - Anexa1',
    ...
    keywords: ['fonduri europene', 'panou vizibilitate proiect', 'panouri santier fonduri europene', 'placi permanente proiect', 'manual identitate vizuala', 'anexa1'],
    alternates: {
