...
export const metadata: Metadata = {
    ...
    keywords: ['carti de vizita', 'print carti de vizita', 'personalizate', 'business cards', 'carton', 'plastic', 'anexa1'],
    alternates: {
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start mb-16">
                            ...
                            <div className="bg-slate-50 p-8 rounded-3xl border border-slate-200 shadow-xl shadow-slate-200/50">
                                ...
                                <p className="text-slate-600 mb-4 leading-relaxed">
                                    Dimensiunea finală standard recomandată pe plan intern este de <strong className="text-blue-600">90x50 mm</strong> sau formatul bancar la <strong className="text-blue-600">85x54 mm</strong>. Dimensiunea brută (bleed-ul) se lasă întotdeauna cu minim +2mm de jur împrejur.
                                </p>
