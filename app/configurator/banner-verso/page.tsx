...
export const metadata = {
    title: 'Banner Față-Verso Blockout pentru Bannere Suspendate - Anexa1',
    ...
    keywords: ['banner fata-verso', 'banner blockout', 'banner suspendat strada', 'print dubla fata', 'publicitate stradala', 'anexa1'],
                    ...
                    faqs={[
                        {
                            ...
                            answer: "Da, poliplanul tip Blockout folosit de Anexa1 este de obicei în standardul de greutate High (între 500g și 610g/mp), fiind mult mai adânc ranforsat pentru stabilitate anti-rupere superioară la vânturi puternice."
                        },
                        {
                                ...
                                {[
                                    {
                                        ...
                                        a: "Da, poliplanul tip Blockout folosit de Anexa1 este de obicei în standardul de greutate High (între 500g și 610g/mp), fiind mult mai adânc ranforsat pentru stabilitate anti-rupere superioară la vânturi puternice."
                                    },
                                    {
