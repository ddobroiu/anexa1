...
export const metadata: Metadata = {
    title: 'Pliante Personalizate - Pliere Z-fold, C-fold pentru Business - Anexa1',
    ...
    keywords: ['pliante personalizate', 'brosuri', 'print pliante', 'flyere indoite', 'marketing offline', 'pliante ieftine', 'anexa1'],
    alternates: {
