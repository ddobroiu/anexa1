...
export const metadata: Metadata = {
    ...
    keywords: ['8 martie', 'canvas 8 martie', 'cadou ziua femeii', 'cadou mama', 'tablou canvas personalizat', 'anexa1'],
    alternates: {
        canonical: 'https://www.Anexa1.ro/configurator/canvas-8-martie',
    },
};
