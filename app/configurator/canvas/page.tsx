...
export const metadata: Metadata = {
    title: "Tablou Canvas pentru Birou sau Showroom | Anexa1",
    ...
    keywords: ['tablou canvas birou', 'canvas decor showroom', 'print canvas business', 'anexa1', 'visionboard canvas'],
};
    ...
    return (
        <>
            ...
            <div className="pt-20">
                ...
                {/* SEO CONTENT SECTION — conținut unic Anexa1 */}
                    ...
                    <div className="container mx-auto px-4 max-w-5xl">
                        <div className="text-center mb-12">
                            ...
                            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                                Un tablou canvas cu vizualul de brand potrivit schimbă vizibil un birou, un showroom sau o recepție — printăm pe <strong className="text-blue-600">pânză 100% bumbac</strong>, pe șasiu din lemn natural uscat, gata de montat.
                            </p>
                        </div>

                        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start mb-16">
                            <div className="space-y-6">
                                <h3 className="text-2xl font-bold text-slate-800 border-b-2 border-blue-500 pb-2 inline-block">Pentru ce se folosește în practică</h3>
