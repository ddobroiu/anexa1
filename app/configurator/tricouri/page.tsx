...
export const metadata: Metadata = {
    title: 'Tricouri cu Logo pentru Echipă sau Eveniment | Anexa1',
    ...
    keywords: ['tricouri cu logo firma', 'tricouri echipa', 'tricouri promotionale', 'print dtf', 'anexa1'],
    alternates: {
                ...
                <div className="container mx-auto px-4 max-w-5xl">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                            <strong className="text-blue-600">Logo-ul firmei</strong>, pe bumbac 100%, print DTF rezistent — potrivit pentru echipe de lucru, staff de eveniment sau materiale promoționale.
                        </p>
                    </div>
