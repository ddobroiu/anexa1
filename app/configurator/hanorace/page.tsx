...
export const metadata: Metadata = {
    title: 'Hanorace Personalizate cu Logo pentru Echipă - Anexa1',
    ...
    keywords: ['hanorac personalizat cu logo', 'hanorace echipa', 'echipament de lucru personalizat', 'print dtf', 'anexa1'],
    alternates: {
