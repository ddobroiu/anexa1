...
export const metadata: Metadata = {
    title: 'Semnalistică și Panouri Indicatoare pentru Business - Anexa1',
    ...
    keywords: ['semnalistica', 'panouri indicatoare', 'semne protectia muncii', 'panouri directionale', 'semnalistica interioara', 'anexa1'],
    alternates: {
