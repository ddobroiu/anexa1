...
export const metadata: Metadata = {
    ...
    keywords: ['autocolante personalizate', 'stickere personalizate', 'oracal', 'vinyl', 'etichete', 'anexa1'],
    alternates: {
                ...
                <FAQSchema
                    faqs={[
                        ...
                        },
                        {
                            ...
                            answer: "Da, printul UV din dotarea Anexa1 aplicat pe folie de PVC devine absolut impermeabil. În plus, alegând laminarea, autocolantul rezistă la solvenți de spălare blânzi și frecare (ex: spălătorie auto)."
                        }
                    ]}
                />
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start mb-16">
                            ...
                            <div className="bg-slate-50 p-8 rounded-3xl border border-slate-200 shadow-xl shadow-slate-200/50">
                                ...
                                <p className="text-slate-600 leading-relaxed">
                                    În Illustrator sau Corel Draw, creează un layer special denumit "CutContour" și trasează o linie subțire Pantone (Spot Color) pe unde dorești să taie lama. În lipsa acestuia, echipa de DTP Anexa1 se va ocupa gratuit de generarea liniei de contur pe grafică.
                                </p>
                            </div>
                        </div>
                            ...
                            <div className="space-y-6 max-w-3xl mx-auto">
                                {[
                                    ...
                                    },
                                    {
                                        ...
                                        a: "Da, printul UV din dotarea Anexa1 aplicat pe folie de PVC devine absolut impermeabil. În plus, alegând laminarea, autocolantul rezistă la solvenți de spălare blânzi și frecare (ex: spălătorie auto)."
                                    }
                                ].map((faq, idx) => (
