...
export const metadata: Metadata = {
    title: 'Șepci cu Logo pentru Echipă sau Eveniment | Anexa1',
    ...
    keywords: ['sepci cu logo firma', 'sepci promotionale', 'sepci echipa', 'print dtf', 'anexa1'],
    alternates: {
                ...
                <div className="container mx-auto px-4 max-w-5xl">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                            Un accesoriu simplu de vizibilitate de brand — <strong className="text-blue-600">logo-ul tău</strong>, print DTF rezistent, comandat în cantitatea de care ai nevoie, de la o bucată la zeci de exemplare.
                        </p>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start mb-16">
                        <div className="space-y-6">
                            <h3 className="text-2xl font-bold text-slate-800 border-b-2 border-blue-500 pb-2 inline-block">Pentru ce se folosesc</h3>
