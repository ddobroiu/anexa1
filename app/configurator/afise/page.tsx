...
export const metadata: Metadata = {
    ...
    keywords: ['afise personalizate', 'postere personalizate', 'print online', 'anexa1', 'a3', 'a2', 'a1', 'a0', 'tipar afise'],
    alternates: {
                ...
                <FAQSchema
                    faqs={[
                        ...
                        },
                        {
                            ...
                            answer: "Pe Anexa1 primim grafici neconvenționale. Lățimea maximă dintr-o singură coală este guvernată de rola echipamentului (încadrare limită la ~150-320cm), în timp ce lungimea este teoretic nelimitată (putem tipări postere continue de tip Ribbon)."
                        },
                        {
                            ...
                            <div className="space-y-6 max-w-3xl mx-auto">
                                {[
                                    ...
                                    },
                                    {
                                        ...
                                        a: "Pe Anexa1 primim grafici neconvenționale. Lățimea maximă dintr-o singură coală este guvernată de rola echipamentului (încadrare limită la ~150-320cm), în timp ce lungimea este teoretic nelimitată (putem tipări postere continue de tip Ribbon)."
                                    },
                                    {
