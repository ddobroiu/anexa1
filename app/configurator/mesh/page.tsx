...
export const metadata: Metadata = {
  title: 'Mesh Publicitar pentru Fațade și Schele de Șantier - Anexa1',
  ...
  keywords: ['mesh publicitar', 'mesh fatada santier', 'banner mesh microperforat', 'plasa publicitara schela', 'print mesh', 'anexa1'],
  alternates: {
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <span className="text-slate-600 text-sm">Tiv și capse gratuite ca la orice banner Anexa1. Configurezi lățimea și înălțimea exactă a fațadei sau gardului tău și primești preț instant.</span>
                  </div>
                </li>
              </ul>
            </div>
