...
export const metadata: Metadata = {
    title: 'Fototapet Personalizat pentru Birou și Showroom - Anexa1',
    ...
    keywords: ['tapet personalizat', 'fototapet birou', 'tapet showroom', 'tapet vinilic', 'decor perete firma', 'anexa1'],
    alternates: {
