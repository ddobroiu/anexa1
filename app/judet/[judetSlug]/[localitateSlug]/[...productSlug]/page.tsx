                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="p-4 w-full flex-1 flex flex-col items-center justify-center bg-white relative">
                                    <h3 className="font-black text-[10px] md:text-xs leading-tight tracking-tight transition-all duration-300 text-slate-800 group-hover:text-blue-600 uppercase italic tracking-tighter">
                                        {config.name}
                                    </h3>
                                </div>
                            </Link>
