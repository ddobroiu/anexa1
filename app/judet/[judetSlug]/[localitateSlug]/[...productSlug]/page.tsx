                        ...
                        <div className="flex-1 w-full order-2 lg:order-1 lg:pt-8">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 mb-12">
                                <a 
                                    ...
                                    className="px-10 py-5 bg-[#25D366] text-white border-2 border-[#25D366] rounded-2xl font-black text-lg hover:border-blue-500 hover:text-blue-600 transition-all flex items-center justify-center gap-3 shadow-sm active:scale-95 group uppercase italic tracking-tighter"
                                >
