...
export const metadata = {
    title: "Panouri și plăcuțe de sediu livrate în toate județele",
    alternates: { canonical: "/judet" },
    description: "Anexa1 produce panouri rigide, plăcuțe de sediu și semnalistică pentru firme din toate cele 41 de județe și din București. Alege județul, vezi produsele și prețurile de pornire. Producție 2-4 zile lucrătoare.",
};
            ...
            <div className="border-b border-slate-100 mb-12">
                <div className="container mx-auto px-6 py-16">
                    <h1 className="text-4xl md:text-6xl font-black text-slate-900 tracking-tighter mb-4">
                         Panouri și plăcuțe de sediu <span className="text-blue-500">în toate județele</span>
                    </h1>
            ...
            <div className="container mx-auto px-6">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-y-6 gap-x-12">
                        {judete.map((judet) => (
                            <Link
                                ...
                                className="group flex items-center justify-between py-2 border-b border-slate-200/50 hover:border-blue-500 transition-all"
                            >
                                <span className="text-lg font-black text-slate-700 group-hover:text-blue-600 transition-colors uppercase tracking-tight">
                                    {judet.name}
                                </span>
                                <ArrowRight className="text-slate-300 group-hover:text-blue-500 group-hover:translate-x-1 transition-all" size={18} />
                            </Link>
                        ))}
                    </div>
                </div>
                ...
                <div className="mt-20 max-w-3xl">
                    ...
                    <p className="text-slate-600 leading-relaxed mb-6">
                        Anexa1.ro utilizează o rețea logistică avansată pentru a asigura livrarea materialelor publicitare în orice localitate din România. 
