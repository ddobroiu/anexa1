...
export default async function Page({ searchParams }: { searchParams: Promise<{ [key: string]: string | string[] | undefined }> }) {
  ...
  const url = `${process.env.NEXT_PUBLIC_SITE_URL || "https://www.anexa1.ro"}/canvas`;
        ...
        <div className="container mx-auto px-4 max-w-5xl relative z-10">
          <div className="text-center mb-16 lg:mb-20">
            ...
            <p className="text-xl text-slate-400 max-w-3xl mx-auto font-medium italic leading-relaxed">
              Realizăm <strong className="text-green-400">tablouri canvas de înaltă rezoluție</strong>, folosind pânză premium de bumbac și șasiu din lemn natural. Fiecare tablou este lucrat manual la Anexa1 pentru a asigura o întindere perfectă.
            </p>
          </div>
            ...
            <div className="space-y-6 max-w-3xl mx-auto">
              {[
                ...
                },
                {
                  ...
                  a: "Fiind producători direcți, timpul de producție este de obicei de 2-4 zile lucrătoare de la confirmarea graficii."
                }
              ].map((faq, idx) => (
