                ...
                <section className="overflow-hidden rounded-3xl bg-slate-900 text-white">
                    <div className="flex flex-col gap-6 p-6 sm:p-8 lg:flex-row lg:items-center lg:justify-between">
                        <div className="flex items-center gap-4">
                            <span className="flex size-14 shrink-0 items-center justify-center rounded-2xl bg-blue-500 text-xl font-bold">
                        ...
                        <div className="flex flex-wrap gap-2">
                            <Link href="/configuratoare" className="inline-flex items-center gap-2 rounded-xl bg-blue-500 px-4 py-2.5 text-sm font-semibold text-white hover:bg-blue-400">
                            ...
                            {NAV.map((n) => {
                                ...
                                return (
                                    <li key={n.id} className="shrink-0">
                                        ...
                                        >
                                            <n.icon size={18} className={on ? "text-blue-600" : "text-slate-400"} />
