...
export default async function AccountPage() {
        ...
        return (
            <div className="min-h-[70vh] bg-slate-50 px-4 pb-16 pt-28">
                <div className="mx-auto max-w-md rounded-3xl bg-white p-8 text-center shadow-sm ring-1 ring-slate-200">
                    ...
                    <Link href="/login" className="mt-6 inline-flex w-full justify-center rounded-xl bg-blue-600 px-6 py-3 font-semibold text-white hover:bg-blue-500">
                        Intră în cont
                    </Link>
                </div>
            </div>
    ...
    const whereCondition: any = {
        source: { equals: 'anexa1.ro', mode: 'insensitive' },
        type: 'order',
        OR: [
            { userId },
