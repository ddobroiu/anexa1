...
export default async function AccountPage() {
    ...
    if (!session?.user) {
        return (
            <div className="mx-auto max-w-3xl px-6 py-16 text-center">
                ...
                <Link href="/login" className="inline-block bg-blue-600 text-white px-6 py-2 rounded-lg font-semibold hover:bg-blue-700 transition">
    ...
    const whereCondition: any = {
        ...
        // Filtrare strictă pentru a afișa doar comenzile plasate pe Shopprint
        // Legacy: source null se consideră Prynt (site-ul vechi), deci aici cerem explicit Anexa1.ro
        AND: [
            { source: 'Anexa1.ro' }
        ]
    };
