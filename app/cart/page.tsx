        ...
        return (
            <div className="min-h-[80vh] bg-slate-50 flex flex-col items-center justify-center text-center px-4 relative overflow-hidden">
                ...
                <div className="relative z-10 bg-white p-16 rounded-[3rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.05)] border border-slate-100 flex flex-col items-center max-w-2xl w-full">
                    ...
                    <Link
                        href="/shop"
                        className="bg-slate-950 text-white px-10 h-16 rounded-2xl font-black text-sm uppercase tracking-widest hover:bg-blue-500 transition-all flex items-center gap-3 shadow-xl shadow-slate-900/10 hover:shadow-blue-500/20"
                    >
                ...
                <div className="grid grid-cols-1 xl:grid-cols-3 gap-10">
                                ...
                                <div className="flex-1 flex flex-col justify-between py-2">
                                    <div>
                                        <div className="flex justify-between items-start mb-3 gap-4">
                                            <h3 className="text-2xl font-black text-slate-900 group-hover:text-blue-600 transition-colors line-clamp-2 tracking-tight leading-snug">{item.title || 'Produs'}</h3>
                                            <button
                                    ...
                                    <div className="flex items-center justify-between mt-auto">
                                        <div className="flex items-center gap-4 bg-slate-50 rounded-2xl p-1.5 border border-slate-200">
                                            <button
                                                ...
                                                className="w-10 h-10 flex items-center justify-center rounded-xl bg-white text-slate-500 shadow-sm border border-slate-100 hover:text-blue-500 hover:border-blue-200 transition-colors"
                                            >
                    ...
                    <div className="relative">
                        <div className="sticky top-32 bg-white border border-slate-100/60 p-10 rounded-[3rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.05)] overflow-hidden">
                                ...
                                return (
                                    <div className="space-y-6 mb-12 relative z-10">
                                        ...
                                        <div className="flex justify-between text-slate-500 items-center">
                                            ...
                                            {shippingCost === 0 ? (
                                                <span className="font-black text-blue-500 uppercase text-xs tracking-widest bg-blue-50 px-3 py-1.5 rounded-lg">Gratis</span>
                                            ) : (
                            ...
                            <Link
                                href="/checkout"
                                className="relative z-10 w-full h-16 bg-slate-950 hover:bg-blue-500 text-white rounded-2xl font-black text-sm transition-all flex items-center justify-center gap-3 shadow-xl shadow-slate-900/10 hover:shadow-blue-500/20 uppercase tracking-[0.2em]"
                            >
