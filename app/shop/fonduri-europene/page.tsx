                        ...
                        <div key={product.id} className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 flex flex-col hover:-translate-y-1">
                            ...
                            <div className="relative aspect-[4/3] bg-gray-100 overflow-hidden">
                                ...
                                <div className="absolute top-3 left-3">
                                    <span className="bg-blue-600/90 backdrop-blur text-white text-[10px] font-bold px-2.5 py-1 rounded-full uppercase tracking-wide shadow-sm">
                                        {product.program}
                                    </span>
                                </div>
                            </div>
                            ...
                            <div className="p-6 flex flex-col flex-1">
                                ...
                                <div className="mt-auto pt-4 border-t border-gray-50 flex items-center justify-between">
                                    ...
                                    <Link href={`/programe-finantare/${product.slug}`}>
                                        <Button size="sm" className="rounded-full bg-slate-900 hover:bg-blue-600 transition-colors">
