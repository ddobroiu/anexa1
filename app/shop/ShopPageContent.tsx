    ...
    return (
        <main className="min-h-screen bg-slate-50 pb-20">
            ...
            <div className="relative bg-slate-950 border-b border-slate-900 pt-20 pb-16 px-4 sm:px-6 lg:px-8 overflow-hidden z-10 transition-colors">
                 ...
                 <div className="absolute top-0 right-1/4 w-[600px] h-[600px] bg-blue-500/10 rounded-full blur-[120px] pointer-events-none mix-blend-screen" />
                ...
                <div className="max-w-[1400px] mx-auto relative z-10">
                    <h1 className="text-4xl sm:text-6xl font-black text-white tracking-tight mb-4">
                        Shop <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-teal-400">Premium</span>
                    </h1>
