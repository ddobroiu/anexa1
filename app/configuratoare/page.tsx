        ...
        <div className="min-h-screen bg-slate-50 selection:bg-blue-500 selection:text-white">
                ...
                <div className="container mx-auto px-6 relative z-10">
                    <div className="max-w-3xl">
                        ...
                        <h1 className="text-5xl md:text-7xl font-black text-slate-900 tracking-tighter leading-[0.9] mb-8">
                            Control Total. <br /> <span className="text-blue-500 italic">Ofertare Imediată.</span>
                        </h1>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    {CONFIGURATORS_REGISTRY.map((p, index) => {
                        ...
                        return (
                            ...
                            >
                                <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm hover:shadow-2xl hover:border-blue-200 transition-all duration-500 flex flex-col h-full overflow-hidden relative">
                                    {/* Image Container */}
                                    <div className="aspect-square relative bg-slate-50/50 p-8 flex items-center justify-center overflow-hidden">
                                        ...
                                        <div className="absolute top-4 right-4 translate-x-4 opacity-0 group-hover:translate-x-0 group-hover:opacity-100 transition-all duration-300">
                                            <div className="w-10 h-10 bg-white rounded-xl shadow-lg flex items-center justify-center text-blue-500">
                                                <Settings size={20} />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="p-8 flex flex-col flex-1">
                                        ...
                                        <div className="mt-auto flex items-center justify-between pt-6 border-t border-slate-50">
                                            ...
                                            <div className="w-8 h-8 rounded-full bg-slate-100 text-slate-400 flex items-center justify-center group-hover:bg-blue-500 group-hover:text-white transition-all transform group-hover:rotate-12">
                                                <ArrowRight size={16} />
                                            </div>
                                        </div>
                                    </div>
            ...
            <div className="py-20 bg-slate-900 text-white mx-4 md:mx-6 mb-20 rounded-[4rem] relative overflow-hidden">
                <div className="absolute top-0 left-0 w-full h-full pointer-events-none overflow-hidden opacity-10">
                    <div className="absolute top-0 left-1/4 w-[500px] h-[500px] bg-blue-500 rounded-full blur-[150px]"></div>
                </div>
                <div className="container mx-auto px-6 relative z-10">
