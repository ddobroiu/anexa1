        ...
        <div className="space-y-8">
            ...
            <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-2xl shadow-sm">
                <h2 className="text-xl font-bold mb-6 flex items-center gap-3">
                    <span className="w-8 h-8 rounded-lg bg-blue-600 text-white flex items-center justify-center text-sm shadow-lg shadow-blue-600/30 font-black">1</span>
                    Date de livrare
                </h2>
            ...
            <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-2xl shadow-sm">
                <h2 className="text-xl font-bold mb-6 flex items-center gap-3">
                    <span className="w-8 h-8 rounded-lg bg-blue-600 text-white flex items-center justify-center text-sm shadow-lg shadow-blue-600/30 font-black">2</span>
                    Detalii Facturare
                </h2>
                ...
                <div className="flex w-full overflow-hidden border border-slate-200 dark:border-slate-800 rounded-xl mb-6 p-1 bg-slate-50 dark:bg-slate-950 max-w-sm">
                    <button type="button" onClick={() => { onBill("tip_factura", "persoana_fizica"); setCompanyIdentified(false); }} className={`flex-1 rounded-lg px-4 py-2 text-sm font-bold transition-all duration-200 ${billing.tip_factura === "persoana_fizica" ? "bg-white dark:bg-slate-800 text-blue-600 shadow-sm" : "text-slate-500"}`}>Persoană fizică</button>
                    <button type="button" onClick={() => onBill("tip_factura", "persoana_juridica")} className={`flex-1 rounded-lg px-4 py-2 text-sm font-bold transition-all duration-200 ${billing.tip_factura === "persoana_juridica" ? "bg-white dark:bg-slate-800 text-blue-600 shadow-sm" : "text-slate-500"}`}>Persoană juridică</button>
                </div>

                <div className="mb-6">
                    <label className="flex items-center gap-3 cursor-pointer select-none">
                        <input type="checkbox" checked={sameAsDelivery} onChange={(e) => setSameAsDelivery(e.target.checked)} className="w-5 h-5 rounded border-slate-300 text-blue-600 focus:ring-blue-500" />
                ...
                {billing.tip_factura === "persoana_juridica" && (
                    <div className="bg-blue-50/30 dark:bg-blue-900/10 border border-blue-100 dark:border-blue-900/30 rounded-xl p-6 mb-6 space-y-4">
                        ...
                        {companyIdentified && billing.denumire_companie && (
                            <div className="rounded-xl border border-blue-200 bg-white dark:bg-slate-900 p-4 space-y-2">
                                <p className="text-sm font-bold text-blue-800 dark:text-blue-300">Date firmă identificate</p>
...
function inputCls(hasError?: string, disabled?: boolean) {
    return `w-full rounded-xl border px-4 py-2.5 focus:outline-none focus:ring-2 bg-white dark:bg-slate-900 text-slate-900 dark:text-white border-slate-200 dark:border-slate-800 focus:ring-blue-500 placeholder-slate-400 transition-all font-medium ${hasError ? "border-red-500 ring-1 ring-red-500/20" : ""} ${disabled ? "opacity-50 cursor-not-allowed" : ""}`;
}
