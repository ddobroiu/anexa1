    ...
    return (
        <main className="min-h-screen bg-slate-50 dark:bg-slate-950 pt-24 sm:pt-32 pb-12 flex items-center justify-center px-4">
            ...
            <div className="max-w-2xl w-full">
                <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 p-8 sm:p-12 shadow-2xl shadow-blue-500/5 text-center relative overflow-hidden">
                    {/* Background accent */}
                    <div className="absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-blue-500 to-blue-500"></div>

                    <div className="w-20 h-20 bg-blue-100 dark:bg-blue-500/10 rounded-2xl flex items-center justify-center mx-auto mb-8 transform rotate-3 shadow-inner">
                        <svg className="w-10 h-10 text-blue-600 dark:text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
                        <div className="bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-800 rounded-2xl p-5 transition-all hover:border-blue-500/30">
                        ...
                        <div className="bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-800 rounded-2xl p-5 transition-all hover:border-blue-500/30">
                            ...
                            <div className={`text-xl font-bold ${paymentStatus === 'Plătit' ? 'text-blue-600 dark:text-blue-400' : 'text-slate-700 dark:text-slate-200'}`}>
                    ...
                    {paymentMethod === 'OP' && (
                        <div className="mb-10 text-left bg-blue-50 dark:bg-blue-950/30 border border-blue-100 dark:border-blue-900/50 rounded-2xl p-6 sm:p-8">
                            <h3 className="text-blue-900 dark:text-blue-300 font-black text-lg mb-4 flex items-center gap-2">
                            ...
                            <div className="space-y-4 text-sm font-medium">
                                <div className="flex justify-between items-center border-b border-blue-200/30 pb-3">
                                ...
                                <div className="flex justify-between items-center border-b border-blue-200/30 pb-3">
                                    ...
                                    <span className="text-blue-600 dark:text-blue-400 font-black text-xs sm:text-sm select-all">{BANK_TRANSFER_IBAN}</span>
                                </div>
                                <div className="flex justify-between items-center">
                                    <span className="text-slate-500 dark:text-slate-400 font-bold uppercase text-[10px] tracking-wider">Referință</span>
                                    <span className="px-3 py-1 bg-white dark:bg-slate-800 rounded-lg text-blue-600 dark:text-blue-300 font-black border border-blue-200/50">Comanda #{orderNo || '...'}</span>
                                </div>
                            </div>
                            <p className="mt-6 text-xs text-blue-800/60 dark:text-blue-400/60 text-center font-bold">
                                * Te rugăm să trimiți dovada plății la contact@anexa1.ro pentru procesare imediată.
                            </p>
                        </div>
                    )}
                    ...
                    <div className="mt-12 pt-8 border-t border-slate-100 dark:border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4 text-[10px] font-black uppercase tracking-[0.2em] text-slate-400">
                        <span>© {new Date().getFullYear()} Anexa1.ro</span>
                        <div className="flex gap-4">
                            <span className="text-blue-500">Securizat SSL</span>
