...
export const metadata: Metadata = {
    ...
    description: 'Află cum colectăm, utilizăm și protejăm datele tale personale conform GDPR. Anexa1.ro respectă intimitatea ta și asigură securitatea datelor prin măsuri...',
    keywords: ['confidențialitate', 'gdpr', 'protectia datelor', 'anexa1', 'politica date'],
    alternates: {
    ...
    return (
        <div className="container mx-auto px-4 pb-12 pt-28 max-w-4xl text-gray-800 dark:text-gray-200">
            ...
            <div className="prose dark:prose-invert max-w-none space-y-6">
                ...
                <p><strong>Persoana de contact DPO:</strong> contact@Anexa1.ro | <strong>Telefon:</strong> 0750.473.111</p>
                ...
                <section>
                    ...
                    <div className="bg-orange-50 dark:bg-orange-900/30 p-4 rounded-lg border border-orange-200 dark:border-orange-800 mb-4">
                        ...
                        <p className="text-orange-700 dark:text-orange-400 text-sm">
                            <strong>Anexa1.ro</strong> oferă exclusiv <strong>produse personalizate</strong> (bannere, afișe, flyere, canvas, autocolante, etc.)
                ...
                <section className="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg border border-green-200 dark:border-green-800">
                    ...
                    <div className="grid md:grid-cols-2 gap-4 mt-3">
                        ...
                        <div>
                            ...
                            <ul className="list-disc pl-5 text-sm space-y-1">
                                <li><strong>Email:</strong> contact@Anexa1.ro</li>
                ...
                <section className="mt-8 border-t pt-6">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">
                        Pentru întrebări juridice: <a href="mailto:contact@Anexa1.ro" className="text-blue-600 underline">contact@Anexa1.ro</a>
                    </p>
                </section>
            </div>
        </div>
