...
export const metadata = {
    ...
    description: "Vezi termenii și condițiile de utilizare și procesare comenzi pe Anexa1.ro.",
};
        ...
        <main className="min-h-screen bg-white dark:bg-slate-900 text-slate-900 dark:text-gray-100 px-4 pb-12 pt-28">
            <div className="max-w-3xl mx-auto rounded-xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow p-8">
                ...
                <p className="text-slate-600 dark:text-slate-400 mb-4">
                    Anexa1.ro este o platformă online care oferă servicii de tipar digital și producție publicitară. Prețurile afișate includ TVA, iar comenzile sunt procesate doar după confirmarea plății sau acceptarea comenzii.
                </p>

                <h2 className="text-xl font-semibold mt-6 mb-2">2. Comenzi și livrare</h2>
                <p className="text-slate-600 dark:text-slate-400 mb-4">
                    Termenul standard de producție este de 2-4 zile lucrătoare de la confirmarea comenzii, la care se adaugă timpul de livrare prin curier. Livrarea se face prin DPD România. Anexa1.ro nu este responsabil pentru întârzierile datorate firmelor de curierat.
                </p>
                ...
                <p className="text-slate-600 dark:text-slate-400 mb-4">
                    Clientul este responsabil de drepturile asupra imaginilor, textelor sau designului încărcat pentru tipar. Anexa1.ro nu își asumă răspunderea pentru conținutul trimis de client.
                </p>
                ...
                <div className="bg-green-50 dark:bg-green-900/30 p-4 rounded-lg border border-green-200 dark:border-green-800 mb-4">
                    ...
                    <ul className="list-disc pl-5 mt-2 space-y-1 text-sm text-green-800 dark:text-green-400">
                        ...
                        <li><strong>Procedura:</strong> Notificare prin email la contact@Anexa1.ro cu formularul de retragere</li>
                        <li><strong>Costuri returnare:</strong> Suportate de consumator, cu excepția produselor defecte</li>
                    </ul>
                </div>
                <div className="bg-blue-50 dark:bg-blue-900/30 p-4 rounded-lg border border-blue-200 dark:border-blue-800 mb-4">
                    <p className="text-blue-900 dark:text-blue-300"><strong>Garanția de conformitate (24 luni - Legea 449/2003):</strong></p>
                    <ul className="list-disc pl-5 mt-2 space-y-1 text-sm text-blue-800 dark:text-blue-400">
                        <li>Reclamații calitate: <strong>Maximum 48h</strong> de la primire (cu fotografii)</li>
                        <li>Defecte aparente: Notificare imediată la contact@Anexa1.ro</li>
                ...
                <p className="text-slate-600 dark:text-slate-400 mb-4">
                    Prin acceptarea acestor termeni, sunteți de acord ca Anexa1.ro să vă contacteze prin e-mail, SMS sau aplicații de mesagerie (WhatsApp) pentru notificări legate de comandă.
                </p>
                <p className="text-slate-600 dark:text-slate-400 mb-4">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <p className="text-slate-600 dark:text-slate-400 text-sm">
                            Email: <a href="mailto:contact@Anexa1.ro" className="text-blue-600 underline">contact@Anexa1.ro</a><br />
                            Tel: <a href="tel:0750473111" className="text-blue-600 underline">0750 473 111</a><br />
                    ...
                    <div>
                        ...
                        <p className="text-slate-600 dark:text-slate-400 text-sm">
                            Email: contact@Anexa1.ro<br />
                            Returns: contact@Anexa1.ro<br />
                            DPO: contact@Anexa1.ro<br />
