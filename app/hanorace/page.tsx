...
export const metadata = {
    title: "Hanorace Personalizate - Print DTF | Publicitate Outdoor",
    description: "Personalizează hanorace groase din bumbac cu design-ul tău. Imprimare DTF rezistentă, culori vibrante, materiale premium. Comandă online rapid. Sistem centralizat pentru outdoor și indoor. Print de mari și mici dimensiuni cu preț de producător și rezistență UV.",
    keywords: [
...
export default async function HanoracePage({ searchParams }: Props) {
    ...
    const url = `${process.env.NEXT_PUBLIC_SITE_URL || "https://www.Anexa1.ro"}/hanorace`;
    ...
    return (
        <main className="min-h-screen bg-slate-50 pt-20">
            ...
            <Suspense fallback={<div className="h-screen flex justify-center items-center"><div className="animate-spin rounded-full h-12 w-12 border-b-2 border-blue-600"></div></div>}>
                ...
                <div className="container mx-auto px-4 max-w-5xl">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                            La <strong className="text-blue-600">Anexa1.ro</strong>, realizăm hanorace Profesional groase (peste 300g), foarte călduroase și confortabile, printate digital folosind utilaje DTF de mare viteză și precizie!
                        </p>
                    </div>
                </div>
            </section>
