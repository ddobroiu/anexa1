            ...
            <div className="max-w-4xl mx-auto rounded-xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow p-8">
                ...
                <div className="bg-blue-50 dark:bg-blue-900/30 p-4 rounded-lg border border-blue-200 dark:border-blue-800 mb-6">
                    ...
                    <p className="text-sm text-blue-700 dark:text-blue-400">
                        <strong>Operator:</strong> CULOAREA DIN VIATA SA SRL | <strong>CUI:</strong> 44820819 | <strong>Contact DPO:</strong> contact@Anexa1.ro | <strong>Termen procesare:</strong> Maximum 30 zile
                    </p>
                </div>
                ...
                <div className="space-y-4">
                    <div className="bg-blue-50 dark:bg-blue-900/30 p-4 rounded-lg border border-blue-200 dark:border-blue-800">
                        <h3 className="font-semibold text-blue-800 dark:text-blue-300 mb-2">Pasul 1: Depunerea cererii</h3>
                        <div className="text-sm text-blue-700 dark:text-blue-400 space-y-2">
                            <p><strong>Modalități de contact:</strong></p>
                            <ul className="list-disc pl-5 space-y-1">
                                <li><strong>Email DPO:</strong> <a href="mailto:contact@Anexa1.ro" className="underline">contact@Anexa1.ro</a> (preferat)</li>
                                <li><strong>Email general:</strong> <a href="mailto:contact@Anexa1.ro" className="underline">contact@Anexa1.ro</a></li>
                ...
                <div className="grid md:grid-cols-3 gap-4 mb-6">
                    ...
                    <div className="bg-blue-50 dark:bg-blue-900/30 p-3 rounded border border-blue-200 dark:border-blue-800">
                        <h4 className="font-semibold text-blue-800 dark:text-blue-300 text-sm mb-2">Activitate site</h4>
                ...
                <div className="bg-orange-50 dark:bg-orange-900/30 p-4 rounded-lg border border-orange-200 dark:border-orange-800 mb-4">
                    ...
                    <p className="text-sm text-orange-700 dark:text-orange-400 mb-2">
                        <strong>Anexa1.ro</strong> realizează exclusiv <strong>produse personalizate</strong> (bannere, afișe, canvas, autocolante) după designul și specificațiile clientului.
                    ...
                    <div>
                        <div className="bg-slate-50 dark:bg-slate-900/50 p-4 rounded border dark:border-slate-700">
                            ...
                            <p className="text-sm space-y-1">
                                ...
                                Telefon: <a href="tel:0750473111" className="text-blue-600 underline">0750 473 111</a><br />
                ...
                <div className="mt-8 border-t dark:border-slate-700 pt-6">
                    ...
                    <div className="text-center space-x-4">
                        <Link href="/confidentialitate" className="text-blue-600 underline hover:text-blue-500 text-sm">
                            Politica de confidențialitate
                        </Link>
                        <Link href="/politica-cookies" className="text-blue-600 underline hover:text-blue-500 text-sm">
                            Politica cookies
                        </Link>
