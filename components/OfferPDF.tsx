        ...
        <Document>
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.headerBg}>
                    <View>
                        <Text style={styles.headerTitle}>Anexa1.ro</Text>
                ...
                <View style={styles.section}>
                    <View>
                        ...
                        <Text style={styles.value}>Email: contact@Anexa1.ro</Text>
                ...
                <View style={styles.footer}>
                    ...
                    <Text style={styles.footerText}>Generat automat de asistentul Anexa1.ro</Text>
                    <Text style={styles.footerText}>Contact: contact@Anexa1.ro | 0750.473.111</Text>
                </View>
