...
export default function DeliveryEstimation({ county }: Props) {
    ...
    return (
        <div className="text-[11px] sm:text-xs flex items-center gap-1.5 bg-gradient-to-r from-blue-50/50 to-teal-50/50 border border-blue-100 rounded-xl px-3 py-2 shadow-sm whitespace-nowrap">
            ...
            {loading ? (
                ...
                <span className="font-extrabold text-blue-700">{label}</span>
            )}
        </div>
    );
}
