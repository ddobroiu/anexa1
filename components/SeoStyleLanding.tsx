                    ...
                    <div className="flex flex-col lg:flex-row gap-16 items-center">
                        <div className="flex-1 text-center lg:text-left">
                            <div className="inline-flex items-center gap-2 px-3 py-1 bg-white border border-slate-200 rounded-lg text-slate-400 text-[10px] font-black uppercase tracking-[0.2em] mb-8 shadow-sm">
                                <Palette size={14} className="text-blue-500" /> CURATOR DESIGN {style.name}
                            </div>
                            
                            <h1 className="text-4xl md:text-6xl font-black text-slate-900 leading-tight mb-6 uppercase tracking-tighter">
                                {style.name} <br />
                                <span className="text-blue-500 italic lowercase font-medium tracking-normal text-3xl md:text-5xl border-b-2 border-blue-500/20">estetică și rafinament</span>
                            </h1>
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 mb-12 justify-center lg:justify-start">
                                <button 
                                    ...
                                    className="px-8 py-4 bg-slate-900 text-white rounded-xl font-bold text-sm hover:bg-blue-500 transition-all flex items-center justify-center gap-3 shadow-lg active:scale-95 uppercase tracking-widest"
                                >
                                    <Zap size={18} /> CONFIGURARE ONLINE
                                </button>
                                <a 
                                    href="https://wa.me/40750473111"
                                    className="px-8 py-4 bg-white text-slate-900 border border-slate-200 rounded-xl font-bold text-sm hover:border-blue-500 hover:text-blue-500 transition-all flex items-center justify-center gap-3 active:scale-95 uppercase tracking-widest"
                                >
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                        <div className="order-2 lg:order-1">
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                {style.keyElements.map((el: string, i: number) => (
                                    <div key={i} className="p-8 bg-[#fafbfc] rounded-2xl border border-slate-100 hover:border-blue-200 transition-all group">
                                        <div className="w-10 h-10 bg-white border border-slate-100 text-blue-500 rounded-xl flex items-center justify-center mb-6 shadow-sm group-hover:bg-blue-500 group-hover:text-white transition-all">
                        ...
                        <div className="order-1 lg:order-2">
                            ...
                            <h2 className="text-3xl md:text-5xl font-black text-slate-900 tracking-tighter uppercase mb-6 leading-tight">Anatomia <br /> <span className="text-blue-500 italic">vizuală a stilului.</span></h2>
                            <p className="text-lg text-slate-500 font-medium leading-relaxed mb-10 max-w-xl">
                                {style.longDescription}
                            </p>
                            <button onClick={onStartConfig} className="px-8 py-4 bg-blue-500 text-white rounded-xl font-bold text-sm hover:bg-slate-900 transition-all uppercase tracking-widest flex items-center gap-2">
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                        {style.matchingSpaces.map((space: string, i: number) => (
                            <div key={i} className="p-8 bg-white border border-slate-100 rounded-2xl text-center hover:border-blue-500 transition-all group shadow-sm">
                                <h4 className="text-base font-black text-slate-900 uppercase tracking-tight group-hover:text-blue-500 transition-colors leading-none">{space}</h4>
                            </div>
                        ))}
                    </div>
                </div>
                ...
                <div className="max-w-[1440px] mx-auto px-6">
                    <div className="text-center mb-16">
                        <div className="inline-flex items-center gap-2 px-3 py-1 bg-slate-50 rounded-lg text-slate-400 text-[9px] font-black uppercase tracking-widest mb-4">
                            <MousePointer2 size={16} className="text-blue-500" /> CATALOG ACTUALIZAT {new Date().getFullYear()}
                        </div>
                        <h2 className="text-3xl md:text-5xl font-black text-slate-900 tracking-tighter uppercase leading-tight">Produsul tău, <span className="text-blue-500 italic">stilul tău.</span></h2>
                    </div>
                ...
                <div className="max-w-4xl mx-auto px-6">
                    <div className="text-center mb-16 px-4">
                        <div className="inline-flex items-center gap-2 px-3 py-1 bg-white border border-slate-200 rounded-lg text-slate-400 text-[9px] font-black uppercase tracking-widest mb-4">
                            <HelpCircle size={14} className="text-blue-500" /> SUPORT DETALII
                        </div>
                    ...
                    <div className="space-y-4 px-4">
                        { [
                            ...
                            <div key={i} className="bg-white p-8 rounded-2xl border border-slate-100 hover:border-blue-200 transition-all group">
                                <h4 className="text-base font-black text-slate-900 mb-4 flex items-start gap-3 uppercase tracking-tight">
                                    <span className="text-blue-500">{i+1}.</span> {faq.q}
                                </h4>
                                <div className="pl-6 text-slate-500 text-sm font-medium leading-relaxed border-l border-slate-100 group-hover:border-blue-500 transition-colors">
                                    {faq.a}
                                </div>
                            </div>
                        ))}
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
                        {[
                            ...
                            <div key={i} className="text-center group flex flex-col items-center">
                                <div className="w-12 h-12 rounded-xl bg-slate-50 border border-slate-100 flex items-center justify-center text-blue-500 mb-4 group-hover:bg-slate-900 group-hover:text-white transition-all">
                                    <item.icon size={20} />
                                </div>
