                    ...
                    <div className="flex flex-col lg:flex-row gap-16 items-center">
                        <div className="flex-1 text-center lg:text-left">
                            <div className="inline-flex items-center gap-2 px-3 py-1 bg-white border border-slate-200 rounded-lg text-slate-400 text-[10px] font-black uppercase tracking-[0.2em] mb-8 shadow-sm">
                                <ShieldCheck size={14} className="text-blue-500" /> CONFORMITATE {data.lawReference}
                            </div>
                            
                            <h1 className="text-4xl md:text-5xl font-black text-slate-900 leading-tight mb-6 uppercase tracking-tighter italic">
                                {data.name} <br />
                                <span className="text-blue-500 not-italic">STANDARD {new Date().getFullYear()}</span>
                            </h1>
                            ...
                            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 opacity-80">
                                {data.standardSpecs.slice(0, 4).map((spec: string, i: number) => (
                                    <div key={i} className="text-left border-l-2 border-blue-500 pl-4">
                        ...
                        <div className="flex-1 w-full max-w-[500px] lg:max-w-none">
                            <div className="relative p-6 bg-white border border-slate-100 rounded-[2.5rem] shadow-xl overflow-hidden">
                                ...
                                />
                                <div className="absolute top-4 right-4 bg-blue-500 text-white px-3 py-1.5 rounded-lg text-[9px] font-black uppercase tracking-widest shadow-lg">
                                    CERTIFICAT ISO
                                </div>
                            </div>
                        </div>
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                        <div>
                            ...
                            <h2 className="text-3xl md:text-5xl font-black text-slate-900 tracking-tighter uppercase mb-6 leading-tight">Specificații <br /> <span className="text-blue-500 italic">conform normei.</span></h2>
                        ...
                        <div className="bg-[#f8fafc] border border-slate-100 p-10 md:p-16 rounded-[3.5rem] relative overflow-hidden">
                            <h3 className="text-xl font-black uppercase tracking-widest mb-10 text-slate-900 flex items-center gap-3 italic">
                                <Info size={24} className="text-blue-500" /> Detalii Tehnice:
                            </h3>
                            <div className="space-y-4">
            ...
            <div className="py-24 bg-[#f8fafc] border-y border-slate-100">
                <div className="max-w-[1440px] mx-auto px-6">
                    <div className="text-center mb-16">
                        ...
                        <h2 className="text-3xl md:text-5xl font-black text-slate-900 tracking-tighter uppercase leading-tight italic">Sisteme de <span className="text-blue-500 not-italic">Semnalizare.</span></h2>
                    </div>
                ...
                <div className="max-w-4xl mx-auto px-6">
                    <div className="text-center mb-16">
                        <div className="inline-flex items-center gap-2 px-3 py-1 bg-slate-50 rounded-lg text-slate-400 text-[9px] font-black uppercase tracking-widest mb-4">
                            <HelpCircle size={14} className="text-blue-500" /> INFO CONFORMITATE
                        </div>
                    ...
                    <div className="space-y-4 px-4 text-left">
                        {[
                            ...
                            <div key={i} className="bg-slate-50 p-8 rounded-2xl border border-slate-100 group hover:border-blue-200 transition-all">
            ...
            <div className="py-20 bg-[#f8fafc] border-t border-slate-100">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                        <div className="text-center group border border-slate-100 p-10 rounded-3xl bg-white shadow-sm hover:border-blue-500 transition-all">
                            <div className="w-12 h-12 bg-slate-50 text-blue-500 rounded-xl flex items-center justify-center mx-auto mb-6 group-hover:bg-slate-900 group-hover:text-white transition-all">
                                <ShieldCheck size={24} />
                            </div>
