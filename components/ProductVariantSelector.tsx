                ...
                >
                    ...
                    <div className="md:w-5/12 lg:w-1/2 relative h-48 sm:h-64 md:h-auto bg-slate-100 overflow-hidden group shrink-0">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8 text-white z-10">
                            <span className="inline-flex items-center gap-1.5 px-3 py-1 mb-2 md:mb-4 text-[10px] md:text-xs font-bold tracking-widest uppercase bg-white/10 backdrop-blur-md rounded-full border border-white/20 text-blue-300 shadow-sm transition-all duration-300">
                            ...
                            {variants.map((variant, index) => {
                                ...
                                return (
                                    <motion.button
                                        ...
                                        className="group relative flex items-center gap-5 p-4 rounded-2xl border-2 border-slate-100 hover:border-blue-500/30 hover:shadow-xl hover:shadow-blue-500/10 hover:-translate-y-1 transition-all duration-300 bg-white text-left w-full overflow-hidden"
                                    >
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-center justify-between mb-1">
                                                <span className="font-bold text-lg text-slate-900 group-hover:text-blue-900 transition-colors truncate pr-2">
                                                    {info.name}
                                                </span>
                                            </div>
                                        ...
                                        {/* Price Badge */}
                                        <div className="shrink-0 flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-slate-50 border border-slate-100 group-hover:bg-white group-hover:border-blue-100 group-hover:text-blue-600 transition-all shadow-sm">
                                        ...
                                        {/* <div className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-300 group-hover:text-blue-600 group-hover:translate-x-1 transition-all opacity-0 group-hover:opacity-100">
