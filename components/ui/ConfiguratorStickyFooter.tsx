        ...
        <div className="static mt-8 left-0 w-full bg-white/95 backdrop-blur-md border-t border-slate-200 p-4 pb-safe shadow-[0_-5px_15px_rgba(0,0,0,0.08)] z-50 lg:hidden block animate-in slide-in-from-bottom-5">
            <div className="flex items-center justify-between gap-4 max-w-7xl mx-auto">
                <div>
                    ...
                    <div className="text-xl font-black text-slate-900">{displayPrice}</div>
                    {deliveryText && (
                ...
                <button
                    ...
                    className="bg-indigo-600 hover:bg-indigo-700 disabled:bg-slate-300 disabled:text-slate-500 text-white px-6 py-3 rounded-xl font-bold text-sm shadow-lg shadow-indigo-500/20 active:scale-95 transition-all flex items-center gap-2"
                >
                    {uploading ? (
