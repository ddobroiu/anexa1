    ...
    return (
        <div className="bg-[#fafafc] min-h-screen">
            ...
            <div className="w-full bg-white border-b border-slate-100 overflow-hidden relative">
                <div className="absolute top-0 right-0 -translate-y-1/2 translate-x-1/4 w-96 h-96 bg-blue-500/5 blur-[120px] rounded-full" />
                ...
                <div className="max-w-7xl mx-auto px-4 py-12 md:py-24 relative z-10">
                    <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
                        <div className="flex-1 order-2 lg:order-1 text-center lg:text-left">
                            <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-blue-50 rounded-full text-blue-600 font-black text-xs uppercase tracking-widest mb-6 border border-blue-100 shadow-sm">
                            ...
                            <h1 className="text-4xl md:text-7xl font-black text-slate-900 leading-[0.95] tracking-tighter mb-8 uppercase">
                                {productName} <br />
                                <span className="text-blue-500">PENTRU {intentLabel}</span>
                            </h1>
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 mb-12 justify-center lg:justify-start">
                                <button onClick={onStartConfig} className="px-10 py-5 bg-slate-950 text-white rounded-2xl font-black text-lg hover:bg-blue-600 transition-all flex items-center justify-center gap-3 shadow-2xl hover:shadow-blue-500/20 active:scale-95 group">
                                    <Zap size={22} className="fill-current group-hover:animate-pulse" /> CONFIGUREAZĂ ACUM
                                </button>
                                <a href={`https://wa.me/40750473111?text=Bună%20ziua,%20mă%20interesează%20${encodeURIComponent(productName)}%20pentru%20${encodeURIComponent(intentLabel)}`} target="_blank" className="px-10 py-5 bg-white text-slate-900 border-2 border-slate-200 rounded-2xl font-black text-lg hover:border-blue-500 hover:text-blue-600 transition-all flex items-center justify-center gap-3 shadow-sm active:scale-95 group">
                                    <MessageCircle size={22} className="group-hover:text-blue-500" /> CERE OFERTĂ
                                </a>
                            </div>

                            <div className="flex flex-wrap justify-center lg:justify-start gap-8 opacity-70">
                                <div className="flex items-center gap-2"><ShieldCheck size={18} className="text-blue-500" /><span className="text-[10px] font-bold text-slate-600 uppercase tracking-widest">Garanție Calitate</span></div>
                        ...
                        <div className="flex-1 order-1 lg:order-2 w-full max-w-[600px] lg:max-w-none">
                            <div className="relative group flex items-center justify-center">
                                <div className="absolute inset-0 bg-gradient-to-tr from-blue-500/10 to-blue-500/5 rounded-full blur-[120px] opacity-40 group-hover:opacity-100 transition-opacity duration-1000" />
            ...
            <div className="py-32 bg-slate-50 relative overflow-hidden">
                ...
                <div className="absolute top-0 right-1/4 w-96 h-96 bg-blue-500/5 blur-[120px] rounded-full" />
                ...
                <div className="max-w-7xl mx-auto px-4 relative z-10">
                    <div className="text-center mb-24">
                        <div className="inline-flex items-center gap-3 px-4 py-2 bg-white rounded-full border border-slate-100 shadow-sm text-slate-400 text-[10px] font-black uppercase tracking-[0.25em] mb-6">
                            <ShieldCheck size={16} className="text-blue-500" /> Standard de Calitate Anexa1
                        </div>
                        <h2 className="text-4xl md:text-7xl font-black text-slate-900 tracking-tighter uppercase leading-[0.9] mb-8">
                            ...
                            <span className="text-blue-500 italic">PENTRU {intentLabel}</span>
                        </h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            ...
                            <div key={i} className={`group bg-white p-12 rounded-[3.5rem] border border-slate-100 shadow-xl ${f.glow} hover:shadow-2xl hover:-translate-y-3 transition-all duration-700 relative overflow-hidden h-full flex flex-col`}>
                                {/* Decorative Number */}
                                <div className="absolute top-0 right-0 -mr-4 -mt-4 text-9xl font-black text-slate-50/50 italic pointer-events-none group-hover:text-blue-50 transition-colors duration-700 select-none">
                                    0{i + 1}
                                </div>
                                ...
                                <h3 className="text-2xl font-black text-slate-900 mb-6 tracking-tight leading-none italic group-hover:text-blue-600 transition-colors uppercase">
                                    {f.title}
                                </h3>
                                ...
                                <div className="mt-10 pt-8 border-t border-slate-50 flex items-center justify-between">
                                    <span className="text-[10px] font-black uppercase text-slate-300 tracking-[0.2em]">Verificat Anexa1</span>
                ...
                <div className="max-w-4xl mx-auto px-4">
                    ...
                    <div className="prose prose-slate max-w-none">
                        <p className="text-lg text-slate-500 font-medium leading-relaxed mb-6">
                            {spintax(`{Atunci când alegi|Dacă ești în căutarea unor} ${productName.toLowerCase()} pentru {scopul de|nevoia ta de} ${intentLabel.toLowerCase()}, {calitatea materialelor|rezistența printului} este {esențială|prioritară}. La Anexa1, {folosim tehnologii de ultimă oră|ne asigurăm} că fiecare ${productName.toLowerCase()} {respectă cele mai înalte standarde|arată impecabil}.`, `${intent}-seo-1`)}
                        </p>
                        <p className="text-lg text-slate-500 font-medium leading-relaxed mb-6">
            ...
            <div className="bg-white py-24 border-t border-slate-100">
                <div className="max-w-4xl mx-auto px-4">
                    <div className="text-center mb-16">
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-50 border border-slate-100 text-slate-500 text-[10px] font-black uppercase tracking-widest mb-4">
                            <HelpCircle size={14} className="text-blue-500" /> SUPORT ȘI CLARITATE
                        </div>
            ...
            <div className="bg-slate-950 py-24 relative overflow-hidden">
                <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
                    ...
                    <p className="text-blue-400/80 text-lg md:text-xl mb-12 font-medium max-w-2xl mx-auto uppercase tracking-widest">Configurează acum online sau vorbește cu un specialist pe WhatsApp pentru o ofertă personalizată.</p>
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <button onClick={onStartConfig} className="px-12 py-6 bg-blue-600 text-white rounded-2xl font-black text-xl hover:bg-blue-500 transition-all flex items-center justify-center gap-3 shadow-xl shadow-blue-500/20 active:scale-95"> <Zap size={24} fill="white" /> CONFIGURATOR </button>
                ...
                <div className="absolute top-0 left-0 w-full h-full opacity-30 pointer-events-none">
                    <div className="absolute top-1/2 left-0 -translate-y-1/2 -translate-x-1/2 w-[500px] h-[500px] bg-blue-500/20 blur-[120px] rounded-full" />
