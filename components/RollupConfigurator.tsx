                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                           {ROLLUP_CONSTANTS.SIZES.map(s => (
                              <button key={s.width_cm} onClick={() => setInput(p => ({ ...p, width_cm: s.width_cm }))} className={`p-4 border-2 rounded-xl text-center transition-all ${input.width_cm === s.width_cm ? 'border-blue-600 bg-blue-50 text-blue-700' : 'border-slate-100 bg-white hover:border-blue-200 text-slate-600'}`}>
               ...
               {activeTab === 'descriere' && (
                 <div className="prose dark:prose-invert max-w-none text-sm leading-relaxed">
                   ...
                   <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 list-none pl-0">
                      <li className="flex items-start gap-2"><Check className="text-blue-600 mt-1 shrink-0" size={16} /> <span><strong>Material Print:</strong> Polipropilenă sau Frontlit 440g cu spate gri (blockout).</span></li>
                      <li className="flex items-start gap-2"><Check className="text-blue-600 mt-1 shrink-0" size={16} /> <span><strong>Casetă:</strong> Aluminiu rezistent cu picioare de susținere.</span></li>
                      <li className="flex items-start gap-2"><Check className="text-blue-600 mt-1 shrink-0" size={16} /> <span><strong>Transport:</strong> Geantă textilă de protecție inclusă în preț.</span></li>
                   </ul>
                 </div>
               )}
