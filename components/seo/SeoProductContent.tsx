      ...
      <div className="container mx-auto px-4 max-w-5xl">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto">
            Realizăm <strong className="text-blue-600">{productName.toLowerCase()} premium</strong>, rezistente în timp, produse eco-friendly la preț de producător. Printăm exact la dimensiunea ta.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start mb-16">
          <div className="space-y-6">
            <h3 className="text-2xl font-bold text-slate-800 border-b-2 border-blue-500 pb-2 inline-block">De ce să ne alegi pe noi?</h3>
          ...
          <div className="bg-slate-50 p-8 rounded-3xl border border-slate-200 shadow-xl shadow-blue-500/5">
