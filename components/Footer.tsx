                ...
                <div className="pt-6 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4 text-xs font-medium text-slate-600">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        ...
                        <div className="flex flex-wrap items-center justify-center gap-4 text-[10px] uppercase font-bold tracking-widest text-slate-600">
                            <a href="https://www.adbanner.ro" target="_blank" rel="noopener noreferrer" className="hover:text-blue-500 transition-colors">AdBanner</a>
                            <a href="https://www.euprint.ro" target="_blank" rel="noopener noreferrer" className="hover:text-blue-500 transition-colors">EuPrint</a>
                            <a href="https://www.prynt.ro" target="_blank" rel="noopener noreferrer" className="hover:text-blue-500 transition-colors">Prynt.ro</a>
                            <a href="https://www.tablou.net" target="_blank" rel="noopener noreferrer" className="hover:text-blue-500 transition-colors">Tablou.net</a>
                            <a href="https://www.shopprint.ro" target="_blank" rel="noopener noreferrer" className="hover:text-blue-500 transition-colors">ShopPrint</a>
                            <a href="https://www.homeprint.ro" target="_blank" rel="noopener noreferrer" className="hover:text-blue-500 transition-colors">HomePrint</a>
                            <span className="text-slate-400">|</span>
                            <a href="https://e-web.ro" target="_blank" rel="noopener noreferrer" className="hover:text-blue-500 transition-colors">Site realizat de e-web.ro</a>
                        </div>
                    </div>
                </div>
            </div>
