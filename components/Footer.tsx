            ...
            <div className="container mx-auto px-6 lg:px-12 !max-w-7xl">
                ...
                <div className="pt-6 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4 text-xs font-medium text-slate-600">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        ...
                        <a href="https://e-web.ro" target="_blank" className="text-[10px] uppercase font-bold tracking-widest text-slate-600 hover:text-blue-500 transition-colors">Site realizat de e-web.ro</a>
                    </div>
                </div>
            </div>
        </footer>
