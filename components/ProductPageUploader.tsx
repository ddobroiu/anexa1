      ...
      {!fileName ? (
        ...
        <div className="flex items-center justify-between p-3 bg-blue-50 border border-blue-200 rounded-xl">
            <div className="flex items-center gap-2 overflow-hidden">
                ...
                <span className="text-sm text-blue-700 truncate font-medium">{fileName}</span>
            </div>
            <button onClick={clearFile} className="p-1 hover:bg-blue-100 rounded-full text-blue-600 transition-colors">
                <X size={16} />
            </button>
        </div>
      )}
