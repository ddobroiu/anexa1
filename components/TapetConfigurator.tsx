                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                   <div className="lg:sticky top-24 h-max space-y-8 text-slate-900 dark:text-white">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          ...
                          <div className="flex items-center gap-4 p-4 bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-gray-200 dark:border-slate-800">
                             <div className="w-10 h-10 bg-blue-50 text-blue-600 rounded-xl flex items-center justify-center shrink-0"><Sparkles size={18} /></div>
                        ...
                        <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-lg border border-gray-200 dark:border-slate-800 px-4">
                           <AccordionStep stepNumber={1} title="Dimensiuni Perete" summary={summaryStep1} isOpen={activeStep === 1} onClick={() => setActiveStep(1)}>
                              <div className="py-4 space-y-6">
                                ...
                                {upsellOpportunity && (
                                    <div className="p-4 bg-blue-50 dark:bg-blue-900/10 rounded-xl border border-blue-100 dark:border-blue-800 flex items-center gap-4 cursor-pointer" onClick={() => setInput(p => ({ ...p, quantity: upsellOpportunity.requiredQty }))}>
                                        ...
                                        <div>
                                            <p className="text-[10px] font-bold text-blue-700 dark:text-blue-400 uppercase tracking-widest mb-0.5">Ofertă Specială</p>
                           ...
                           <AccordionStep stepNumber={3} title="Imagine & Design" summary={summaryStep3} isOpen={activeStep === 3} onClick={() => setActiveStep(3)} isLast={true}>
                              <div className="py-4 space-y-4">
                                ...
                                {input.designOption === 'upload' && (
                                  <label className="flex flex-col items-center justify-center w-full h-32 bg-slate-50 dark:bg-slate-800 border-2 border-slate-200 dark:border-slate-700 border-dashed rounded-xl cursor-pointer hover:border-blue-500 transition-colors">
                                     {uploading ? <div className="animate-spin rounded-full h-6 w-6 border-b-2 border-blue-600"></div> : artworkUrl ? <Check className="text-blue-600" /> : <UploadCloud className="text-gray-400" />}
                       ...
                       {activeTab === 'descriere' && (
                         <div className="prose dark:prose-invert max-w-none text-sm">
                           ...
                           <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 list-none pl-0">
                               <li className="flex items-start gap-2"><Check className="text-blue-600 mt-1 shrink-0" size={16} /> <span><strong>Material:</strong> Coating vinilic 400g/mp cu bază poliester.</span></li>
                               <li className="flex items-start gap-2"><Check className="text-blue-600 mt-1 shrink-0" size={16} /> <span><strong>Certificat:</strong> Clasa B1/M1 la foc, sigur pentru spitale și școli.</span></li>
                               <li className="flex items-start gap-2"><Check className="text-blue-600 mt-1 shrink-0" size={16} /> <span><strong>Custom:</strong> Printăm exact la dimensiunile peretelui tău.</span></li>
                               <li className="flex items-start gap-2"><Check className="text-blue-600 mt-1 shrink-0" size={16} /> <span><strong>UV Printing:</strong> Culori care nu se decolorează sub razele soarelui.</span></li>
                           </ul>
                         </div>
                       )}
