...
function ToastItem({ toast, onRemove }: { toast: Toast; onRemove: (id: string) => void }) {
    const icons = {
        success: <div className="bg-blue-100 p-1.5 rounded-full"><CheckCircle className="w-5 h-5 text-blue-600" /></div>,
        ...
        info: <div className="bg-blue-100 p-1.5 rounded-full"><Info className="w-5 h-5 text-blue-600" /></div>,
    };

    const borders = {
        success: "border-l-4 border-l-blue-500",
