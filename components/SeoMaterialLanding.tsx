                    ...
                    <div className="flex flex-col lg:flex-row gap-16 items-center">
                        <div className="flex-1 text-center lg:text-left">
                            <div className="inline-flex items-center gap-2 px-3 py-1 bg-white border border-slate-200 rounded-lg text-slate-400 text-[10px] font-black uppercase tracking-[0.2em] mb-8 shadow-sm">
                                <Info size={14} className="text-blue-500" /> RESURSĂ TEHNICĂ {material.name}
                            </div>
                            
                            <h1 className="text-4xl md:text-5xl font-black text-slate-900 leading-tight mb-6 uppercase tracking-tighter italic">
                                {material.name} <br />
                                <span className="text-blue-500 not-italic">SPECIFICAȚII PREMIUM</span>
                            </h1>
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 mb-12 justify-center lg:justify-start">
                                <button 
                                    ...
                                    className="px-8 py-4 bg-slate-900 text-white rounded-xl font-bold text-sm hover:bg-blue-500 transition-all flex items-center justify-center gap-2 shadow-lg active:scale-95 uppercase tracking-widest"
                                >
                                    <Zap size={18} /> CONFIGURARE RAPIDĂ
                                </button>
                                <a 
                                    href="https://wa.me/40750473111"
                                    className="px-8 py-4 bg-white text-slate-900 border border-slate-200 rounded-xl font-bold text-sm hover:border-blue-500 hover:text-blue-500 transition-all flex items-center justify-center gap-2 active:scale-95 uppercase tracking-widest"
                                >
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                        <div>
                            ...
                            <h2 className="text-3xl md:text-5xl font-black text-slate-900 tracking-tighter uppercase mb-6 leading-tight">Performanță <br /> <span className="text-blue-500 italic">fără compromis.</span></h2>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                {material.benefits.map((benefit: string, i: number) => (
                                    <div key={i} className="flex gap-4 items-center p-6 bg-slate-50 border border-slate-100 rounded-2xl group hover:border-blue-200 transition-all">
                                        <div className="w-10 h-10 rounded-xl bg-white text-blue-500 flex items-center justify-center shrink-0 border border-slate-100 group-hover:bg-blue-500 group-hover:text-white transition-all shadow-sm">
                        ...
                        <div className="bg-[#f8fafc] border border-slate-100 p-10 md:p-16 rounded-[3.5rem] relative overflow-hidden shadow-sm">
                            <h3 className="text-xl font-black uppercase tracking-widest mb-10 text-slate-900 flex items-center gap-3 italic">
                                <Settings size={24} className="text-blue-500" /> Parametri Tehnici:
                            </h3>
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="text-center mb-16">
                        <div className="inline-flex items-center gap-2 px-3 py-1 bg-white border border-slate-200 rounded-lg text-slate-400 text-[9px] font-black uppercase tracking-widest mb-4 shadow-sm">
                            <ArrowRight size={14} className="text-blue-500" /> APLICAȚII RECOMANDATE
                        </div>
                        <h2 className="text-3xl md:text-5xl font-black text-slate-900 tracking-tighter uppercase leading-tight italic">Unde utilizăm <span className="text-blue-500 not-italic">{material.name}?</span></h2>
                    </div>
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
                        {material.idealFor.map((use: string, i: number) => (
                            <div key={i} className="p-8 bg-white border border-slate-100 rounded-2xl text-center hover:border-blue-500 transition-all group shadow-sm">
                                <h4 className="text-base font-black text-slate-900 uppercase tracking-tight group-hover:text-blue-500 transition-colors leading-none">{use}</h4>
                            </div>
                        ))}
                    </div>
                </div>
                ...
                <div className="max-w-[1440px] mx-auto px-6">
                    <div className="text-center mb-16">
                        <div className="inline-flex items-center gap-2 px-3 py-1 bg-slate-50 rounded-lg text-slate-400 text-[9px] font-black uppercase tracking-widest mb-4 shadow-sm">
                            <Layers size={14} className="text-blue-500" /> CATALOG COMPLET PRODUSE
                        </div>
                        <h2 className="text-3xl md:text-5xl font-black text-slate-900 tracking-tighter uppercase leading-tight italic">Materiale la <span className="text-blue-500 not-italic">Nivel Expert.</span></h2>
                    </div>
            ...
            <div className="py-24 bg-[#f8fafc] border-t border-slate-100">
                <div className="max-w-4xl mx-auto px-6">
                    <div className="text-center mb-16 px-4">
                        <div className="inline-flex items-center gap-2 px-3 py-1 bg-white border border-slate-200 rounded-lg text-slate-400 text-[9px] font-black uppercase tracking-widest mb-4 shadow-sm">
                            <HelpCircle size={14} className="text-blue-500" /> SUPORT TEHNIC
                        </div>
                    ...
                    <div className="space-y-4 px-4 text-left">
                        {[
                            ...
                            <div key={i} className="bg-white p-8 rounded-2xl border border-slate-100 hover:border-blue-200 transition-all group shadow-sm">
                                ...
                                <div className="pl-6 text-slate-500 text-sm font-medium leading-relaxed border-l border-slate-200 group-hover:border-blue-500 transition-colors">
                                    {faq.a}
                                </div>
                            </div>
                        ))}
