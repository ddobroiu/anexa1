            ...
            <div className="w-full max-w-[1600px] bg-white dark:bg-slate-950 lg:rounded-3xl overflow-hidden shadow-2xl border border-border min-h-screen lg:min-h-[800px] flex flex-col lg:flex-row">
                ...
                <div className="relative lg:w-5/12 bg-slate-50 dark:bg-slate-900 p-8 lg:p-16 flex flex-col justify-between overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        <h1 className="text-4xl md:text-5xl lg:text-6xl font-black tracking-tight text-foreground mb-6">
                            Livrare <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-blue-600">rapidă.</span>
                        </h1>
                    ...
                    <div className="relative z-10 mt-12 space-y-8">
                        <div className="flex items-start gap-4 group">
                            <div className="w-12 h-12 rounded-2xl bg-white dark:bg-slate-800 border-border flex items-center justify-center group-hover:border-blue-500/50 group-hover:bg-blue-500/5 transition-all duration-300 shadow-sm border">
                                <Clock className="w-5 h-5 text-foreground group-hover:text-blue-500 transition-colors" />
                            </div>
                            <div>
                        ...
                        <div className="flex items-start gap-4 group">
                            <div className="w-12 h-12 rounded-2xl bg-white dark:bg-slate-800 border-border flex items-center justify-center group-hover:border-blue-500/50 group-hover:bg-blue-500/5 transition-all duration-300 shadow-sm border">
                                <Package className="w-5 h-5 text-foreground group-hover:text-blue-500 transition-colors" />
                            </div>
                            <div>
                ...
                <div className="lg:w-7/12 bg-white dark:bg-slate-950 p-8 lg:p-20 flex flex-col justify-center relative overflow-y-auto">
                    <div className="max-w-2xl mx-auto w-full space-y-12">
                        ...
                        {/* Urmărire Comandă */}
                        <div className="bg-blue-500/5 border border-blue-500/20 rounded-2xl p-8 text-center bg-blue-50 dark:bg-blue-900/10">
