        ...
        <div className="bg-slate-50 dark:bg-slate-800 min-h-screen pb-20">
            ...
            <div className="bg-slate-900 text-white pt-32 pb-16">
                <div className="container mx-auto px-4 text-center">
                    <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-blue-500 text-white mb-6 shadow-lg shadow-blue-500/20">
                        <Sliders size={32} />
                    </div>
                            ...
                            <Link href={`/${product.routeSlug}`} key={product.id} className="group flex flex-col bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-slate-100 hover:-translate-y-1 h-full">
                                <div className="relative aspect-[3/2] bg-gray-100 overflow-hidden border-b border-gray-50">
                                    ...
                                    <div className="absolute top-3 left-3">
                                        <span className="bg-blue-600 text-white text-[10px] font-bold px-2.5 py-1 rounded-md uppercase tracking-wide shadow-sm">
                                            Configurabil
                                        </span>
                                    </div>
                                ...
                                <div className="p-6 flex flex-col flex-1">
                                    ...
                                    <div className="mt-auto pt-4 border-t border-slate-50 flex items-center justify-between">
                                        ...
                                        <div className="w-10 h-10 rounded-full bg-slate-50 dark:bg-slate-800 text-slate-400 flex items-center justify-center group-hover:bg-blue-500 group-hover:text-white transition-all duration-300 shadow-sm group-hover:shadow-blue-500/25">
                                            <ArrowRight size={18} />
                                        </div>
                                    </div>
                                </div>
