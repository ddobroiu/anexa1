...
export default function ProductStructuredData({ product }: ProductStructuredDataProps) {
    ...
    // Only attach aggregateRating when real rating data is available - never fabricate.
    if (product.aggregateRating?.ratingValue && product.aggregateRating?.reviewCount > 0) {
