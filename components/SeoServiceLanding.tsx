        ...
        <div className="bg-white min-h-screen selection:bg-blue-100 selection:text-blue-900">
                    ...
                    <div className="flex flex-col lg:flex-row gap-16 items-center">
                        <div className="flex-1 text-center lg:text-left">
                            <div className="inline-flex items-center gap-2 px-3 py-1 bg-white border border-slate-200 rounded-lg text-slate-400 text-[10px] font-black uppercase tracking-[0.2em] mb-8 shadow-sm">
                                <Sparkles size={14} className="text-blue-500" /> SERVICII PROFESIONALE
                            </div>
                            
                            <h1 className="text-4xl md:text-5xl font-black text-slate-900 leading-tight mb-6 uppercase tracking-tighter italic">
                                {service.name} <br />
                                <span className="text-blue-500 not-italic">CALITATE GARANTATĂ</span>
                            </h1>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                        <div className="order-2 lg:order-1">
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                {service.benefits.map((feat: string, i: number) => (
                                    <div key={i} className="p-8 bg-[#fafbfc] rounded-2xl border border-slate-100 group hover:border-blue-200 transition-all">
                        ...
                        <div className="order-1 lg:order-2">
                            ...
                            <h2 className="text-3xl md:text-5xl font-black text-slate-900 tracking-tighter uppercase mb-6 leading-tight">Proces Tehnic <br /> <span className="text-blue-500 italic">și rigoare.</span></h2>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                            {service.processSteps.map((step: { step: string; desc: string }, i: number) => (
                                <div key={i} className="relative group">
                                    <div className="absolute -top-4 -left-4 w-10 h-10 bg-slate-900 text-white flex items-center justify-center font-black rounded-full z-10 group-hover:bg-blue-500 transition-colors">
                                        {i+1}
                                    </div>
                                    <div className="p-8 bg-white border border-slate-100 rounded-2xl shadow-sm h-full group-hover:border-blue-200 transition-all">
                ...
                <div className="max-w-[1440px] mx-auto px-6">
                    <div className="text-center mb-16">
                        <div className="inline-flex items-center gap-2 px-3 py-1 bg-white border border-slate-200 rounded-lg text-slate-400 text-[9px] font-black uppercase tracking-widest mb-4 shadow-sm">
                            <MousePointer2 size={16} className="text-blue-500" /> CATALOG DIGITAL ACTUALIZAT
                        </div>
                        <h2 className="text-3xl md:text-5xl font-black text-slate-900 tracking-tighter uppercase leading-tight italic">Personalizare <span className="text-blue-500 not-italic">și Print.</span></h2>
                    </div>
            ...
            <div className="py-24 bg-[#fbfbfd] border-t border-slate-100">
                <div className="max-w-4xl mx-auto px-6">
                    <div className="text-center mb-16">
                        <div className="inline-flex items-center gap-2 px-3 py-1 bg-white border border-slate-200 rounded-lg text-slate-400 text-[9px] font-black uppercase tracking-widest mb-4 shadow-sm">
                            <HelpCircle size={14} className="text-blue-500" /> SUPORT ACTIV
                        </div>
