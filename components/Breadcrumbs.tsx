        ...
        "itemListElement": [
            {
                ...
                "position": 1,
                "name": "Acasa",
                "item": "https://www.Anexa1.ro"
            },
            ...items.map((item, index) => ({
                "@type": "ListItem",
                "position": index + 2,
                "name": item.label,
                "item": item.href.startsWith('http') ? item.href : `https://www.Anexa1.ro${item.href}`
            }))
        ]
    };
        ...
        <nav className="w-full max-w-full relative mb-6 pb-2 scrollbar-hide overflow-hidden" aria-label="Breadcrumb">
            ...
            <ol className="flex items-center flex-wrap gap-y-2 whitespace-normal break-words py-1">
                <li className="inline-flex items-center">
                    <Link
                        href="/"
                        className="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 transition-colors p-1"
                    >
