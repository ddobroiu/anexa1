            ...
            <div className="space-y-5">
                <div>
                    ...
                    <div className="relative">
                        <input
                            ...
                            className="w-full pl-4 pr-12 py-3 rounded-xl border-2 border-gray-200 dark:border-gray-700 bg-white dark:bg-slate-900 text-slate-900 dark:text-gray-100 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all duration-200"
                ...
                <div className="flex justify-end pt-2">
                    <button
                        ...
                        onClick={submit}
                        className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-green-600 hover:from-blue-700 hover:to-green-700 text-white rounded-xl font-semibold transition-all duration-200 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
                    >
