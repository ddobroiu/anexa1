                ...
                <>
                    <div className="flex flex-col sm:flex-row gap-2 mt-2">
                        <input
                            ...
                            className="flex-1 rounded-md border border-gray-300 bg-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/40"
                            autoComplete="email"
                        />
                        ...
                        <div className="relative flex-1">
                            <input
                                ...
                                className="w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/40 pr-10"
                    ...
                    <div className="flex flex-col sm:flex-row gap-2">
                        <button
                            ...
                            className="flex-1 rounded-md bg-blue-600 px-4 py-2 text-sm font-semibold text-white hover:bg-blue-500 transition disabled:opacity-60"
                        >
            ...
            {view === 'reset' && (
                <div className="space-y-3">
                    ...
                    <input
                        ...
                        value={email}
                        onChange={(e) => setEmail(e.target.value)}
                        className="w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/40"
                    />
                    ...
                    <button
                        ...
                        className="w-full rounded-md bg-blue-600 px-4 py-2 text-sm font-semibold text-white hover:bg-blue-500 transition disabled:opacity-60"
                    >
                        {loading ? 'Se trimite...' : 'Trimite link resetare'}
                    </button>

                    {resetMsg && <p className="text-blue-600 text-xs">{resetMsg}</p>}
