                ...
                <div className="max-w-[1400px] mx-auto">
                    <div className="text-center mb-16 lg:mb-24">
                        ...
                        <p className="text-xl lg:text-2xl text-slate-400 max-w-3xl mx-auto font-medium italic leading-relaxed">
                            Ai un proiect ambițios? Echipa Anexa1 este aici să transforme viziunea ta în realitate publicitară de impact.
                        </p>
                    </div>
                                ...
                                {sent ? (
                                    <div className="h-full flex flex-col items-center justify-center text-center py-20 animate-in fade-in zoom-in duration-500">
                                        ...
                                        <p className="text-slate-400 text-lg font-medium italic mb-10 max-w-md">
                                            Vă mulțumim pentru încredere. Un consultant Anexa1 vă va contacta în cel mai scurt timp posibil.
                                        </p>
