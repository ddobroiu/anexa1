                ...
                <div className="relative lg:w-5/12 bg-slate-950 p-8 lg:p-16 flex flex-col justify-between overflow-hidden text-white">
                    ...
                    <div className="relative z-10">
                        <Link href="/" className="inline-block mb-16 opacity-70 hover:opacity-100 hover:translate-x-1 transition-all">
                            <span className="text-xs font-black tracking-[0.2em] uppercase text-blue-400">← Înapoi la site</span>
                        </Link>

                        <h1 className="text-5xl lg:text-7xl font-black tracking-tight mb-8 leading-[1.1]">
                            Hai să <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-teal-400">colaborăm.</span>
                        </h1>
                    ...
                    <div className="relative z-10 mt-16 space-y-8">
                        <a href="mailto:contact@Anexa1.ro" className="flex items-start gap-5 group cursor-pointer w-fit">
                            <div className="w-14 h-14 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center group-hover:border-blue-500/50 group-hover:bg-blue-500/10 transition-all duration-300">
                                <svg className="w-6 h-6 text-slate-300 group-hover:text-blue-400 transition-colors" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                            </div>
                            <div className="pt-1">
                                <h3 className="font-bold text-slate-200 text-sm tracking-widest uppercase mb-1">Email</h3>
                                <div className="text-blue-400 font-medium text-lg">contact@Anexa1.ro</div>
                            </div>
                        </a>
                        ...
                        <a href={`tel:${siteConfig.phone.replace(/\s+/g, '').replace(/^0/, '+40')}`} className="flex items-start gap-5 group cursor-pointer w-fit">
                            ...
                            <div className="pt-1">
                                ...
                                <div className="text-blue-400 font-medium text-lg">{siteConfig.phone}</div>
                            </div>
                        </a>
                ...
                <div className="lg:w-7/12 bg-white/80 backdrop-blur-md p-8 lg:p-24 flex flex-col justify-center relative">
                    {sent ? (
                        <div className="text-center animate-in fade-in slide-in-from-bottom-4 duration-700">
                            <div className="w-28 h-28 bg-blue-50 rounded-full flex items-center justify-center mx-auto mb-8 border border-blue-100 relative group">
                                <div className="absolute inset-0 bg-blue-400 rounded-full blur-xl opacity-20 group-hover:opacity-40 transition-opacity"></div>
                                <svg className="w-14 h-14 text-blue-500 relative z-10" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" /></svg>
                            </div>
                            ...
                            <Button onClick={() => setSent(false)} className="bg-slate-950 text-white hover:bg-blue-500 hover:text-white transition-colors uppercase tracking-widest text-xs font-black px-10 h-14 rounded-full shadow-xl shadow-slate-900/10">Trimite un alt mesaj</Button>
                        </div>
                    ) : (
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        <label htmlFor="name" className="text-xs font-bold text-slate-900 uppercase tracking-widest ml-1">Nume complet <span className="text-blue-500">*</span></label>
                                        <Input
                                            id="name" name="name"
                                            placeholder="Ion Popescu"
                                            required
                                            value={form.name} onChange={handleChange}
                                            className="h-14 bg-slate-50 border-slate-200 hover:border-blue-400 focus:border-blue-500 focus:ring-blue-500/20 transition-all rounded-xl font-medium"
                                        />
                                    </div>
                                ...
                                <div className="space-y-2">
                                    <label htmlFor="email" className="text-xs font-bold text-slate-900 uppercase tracking-widest ml-1">Adresă de email <span className="text-blue-500">*</span></label>
                                    <Input
                                ...
                                <div className="space-y-2">
                                    <label htmlFor="message" className="text-xs font-bold text-slate-900 uppercase tracking-widest ml-1">Mesajul tău <span className="text-blue-500">*</span></label>
                                    <textarea
                                        ...
                                        className="flex w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-4 text-slate-900 font-medium placeholder:text-slate-400 placeholder:font-normal focus:outline-none focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 focus:bg-white disabled:cursor-not-allowed disabled:opacity-50 resize-none transition-all"
                                    />
                                </div>

                                <Button type="submit" size="lg" className="w-full h-16 text-xs font-black uppercase tracking-[0.2em] bg-slate-950 text-white hover:bg-blue-500 rounded-xl transition-all shadow-xl shadow-slate-900/10 hover:shadow-blue-500/20 mt-4" disabled={loading}>
                                    {loading ? (
                                ...
                                <p className="text-xs text-center text-slate-500 mt-6 font-medium">
                                    Prin trimiterea acestui formular, ești de acord cu <Link href="/termeni" className="text-slate-900 font-bold underline hover:text-blue-500 transition-colors">Termenii și Condițiile</Link>.
                                </p>
                            </form>
                        </div>
                    )}
