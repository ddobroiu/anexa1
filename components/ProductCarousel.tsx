        ...
        <section className="py-16 border-t border-gray-100 bg-white">
            <div className="container mx-auto px-4">
                <div className="flex items-center justify-between mb-8">
                    ...
                    <Link href="/configurator/canvas" className="text-blue-600 font-bold text-sm hover:underline flex items-center gap-1">
                            ...
                            >
                                <Link href={`/${linkBase}/${product.slug}`} className="block h-full flex flex-col">
                                    ...
                                    <div className="p-4 flex flex-col flex-grow">
                                        <h3 className="font-bold text-slate-900 line-clamp-1 group-hover:text-blue-600 transition-colors mb-1">
                                            {product.title}
                                        </h3>
