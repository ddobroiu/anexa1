...
export default function CartWidget() {
  ...
  async function exportOfferPdfServer() {
    ...
    try {
      ...
      a.href = url;
      a.download = `oferta-anexa1-${date}.pdf`;
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      >
        ...
        {items.length > 0 && (
          <div className="px-4 py-4 border-y-2 border-slate-200 dark:border-green-900/30 shrink-0 bg-white dark:from-green-950/30 dark:to-blue-950/30">
            {remainingForFreeShipping > 0 ? (
              <div className="space-y-2.5">
                ...
                <div className="relative h-3 w-full bg-slate-200 dark:bg-slate-700 rounded-full overflow-hidden shadow-inner">
                  <div
                    className="absolute top-0 left-0 h-full bg-gradient-to-r from-green-500 to-blue-500 transition-all duration-700 ease-out rounded-full shadow-lg"
              ...
              <div className="flex items-center gap-3 text-blue-700 dark:text-blue-400 text-sm font-bold justify-center bg-blue-50 dark:bg-blue-950/30 py-3 px-4 rounded-xl border-2 border-blue-200 dark:border-blue-800">
