...
function TextileTypeSwitch() {
    ...
    return (
        <div className="inline-flex rounded-lg border border-gray-300 bg-white p-1 shadow-sm">
            <Link
                href="/tricouri"
                className={`px-3 py-1.5 rounded-md text-xs sm:text-sm font-semibold transition-all inline-flex items-center justify-center ${isTricouri ? 'bg-blue-600 text-white shadow-md' : 'text-gray-600 dark:text-gray-400 hover:bg-slate-50 dark:bg-slate-800'}`}
            >
                Tricouri
            </Link>
            <Link
                href="/hanorace"
                className={`ml-1 px-3 py-1.5 rounded-md text-xs sm:text-sm font-semibold transition-all inline-flex items-center justify-center ${isHanorace ? 'bg-blue-600 text-white shadow-md' : 'text-gray-600 dark:text-gray-400 hover:bg-slate-50 dark:bg-slate-800'}`}
            >
                Hanorace
            </Link>
            <Link
                href="/sepci"
                className={`ml-1 px-3 py-1.5 rounded-md text-xs sm:text-sm font-semibold transition-all inline-flex items-center justify-center ${isSepci ? 'bg-blue-600 text-white shadow-md' : 'text-gray-600 dark:text-gray-400 hover:bg-slate-50 dark:bg-slate-800'}`}
            >
                Șepci
            </Link>
        </div>
...
function OptionButton({ active, onClick, title, subtitle }: { active: boolean; onClick: () => void; title: string; subtitle?: string; }) {
    return (
        ...
        >
            <div className={`font-bold transition-colors ${active ? "text-blue-700" : "text-gray-800"}`}>{title}</div>
            {subtitle && <div className={`text-xs mt-1 transition-colors ${active ? "text-blue-600/80" : "text-gray-500"}`}>{subtitle}</div>}
        </button>
    );
}

function TabButton({ active, onClick, children }: { active: boolean; onClick: () => void; children: React.ReactNode; }) {
    return <button type="button" onClick={onClick} className={`px-4 py-2 text-sm font-semibold transition-colors rounded-t-lg ${active ? "border-b-2 border-blue-600 text-blue-600 bg-blue-50" : "text-gray-500 hover:text-gray-800"}`}>{children}</button>;
}
                    ...
                    <div>
                                ...
                                <div className="space-y-5">
                                    ...
                                    <div>
                                        ...
                                        <select
                                            ...
                                            className="w-full p-4 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all shadow-sm text-lg font-medium bg-white"
                                        >
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {selectedModelConfig.colors.map(color => (
                                                <button
                                                    ...
                                                    className={`px-3 py-2 text-sm font-semibold rounded-lg border-2 transition-all ${input.color === color ? 'border-blue-600 bg-blue-50 text-blue-700' : 'border-gray-200 dark:border-slate-800 bg-white hover:border-gray-400 text-gray-700 dark:text-gray-300'}`}
                                                >
                                                    {color}
                                                </button>
                                            ))}
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {selectedModelConfig.sizes.map(size => (
                                                <button
                                                    ...
                                                    className={`px-3 py-2 text-sm font-semibold rounded-lg border-2 transition-all ${input.size === size ? 'border-blue-600 bg-blue-50 text-blue-700' : 'border-gray-200 dark:border-slate-800 bg-white hover:border-gray-400 text-gray-700 dark:text-gray-300'}`}
                                                >
                                                    {size}
                                                </button>
                                            ))}
                                ...
                                <div>
                                    ...
                                    {input.designOption === 'text_only' && (
                                        <div className="space-y-3">
                                            ...
                                            <textarea className="w-full p-4 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all shadow-sm text-base min-h-24" rows={3} value={textDesign} onChange={e => setTextDesign(e.target.value)} placeholder="ex: FAȚĂ: Logo mic stânga piept | SPATE: STAFF"></textarea>
                                        </div>
                                    )}
                        ...
                        <div className="relative bg-white border lg:rounded-2xl lg:shadow-lg border-gray-200 dark:border-slate-800 p-3 sm:p-4 lg:p-6 mt-8">
                            <div className="flex flex-col gap-3">
                                <button onClick={handleAddToCart} className="w-full py-4 text-lg font-bold bg-blue-600 text-white rounded-xl shadow-xl hover:bg-blue-700 transition-all flex items-center justify-center gap-2 active:scale-95">
                        ...
                        <div className="mt-4 lg:mt-6 bg-gradient-to-br from-slate-50 to-gray-100 dark:from-slate-800 dark:to-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 p-4">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                <a
                                    ...
                                    className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-green-600 to-blue-600 hover:from-green-700 hover:to-blue-700 text-white font-semibold py-2.5 px-4 rounded-lg shadow-md hover:shadow-lg transition-all duration-200"
                                >
                        ...
                        {activeProductTab === 'descriere' && (
                            <>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 pb-10 border-b border-gray-200 dark:border-slate-800">
                                    <div className="flex items-start gap-4 p-4 rounded-2xl bg-slate-50 dark:bg-slate-800 hover:bg-white hover:shadow-md transition-all border border-transparent hover:border-blue-100">
                                        <div className="shrink-0 w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center shadow-lg">
                                    ...
                                    <div className="flex items-start gap-4 p-4 rounded-2xl bg-slate-50 dark:bg-slate-800 hover:bg-white hover:shadow-md transition-all border border-transparent hover:border-blue-100">
                                        <div className="shrink-0 w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500 to-teal-600 flex items-center justify-center shadow-lg">
                                            <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="p-6 sm:p-8 space-y-6">
                            ...
                            <section>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <div className="p-4 border border-gray-200 dark:border-slate-800 rounded-2xl hover:border-blue-200 transition-colors">
                            ...
                            <div className="bg-blue-600 text-white p-6 rounded-3xl shadow-xl shadow-blue-200 flex flex-col sm:flex-row items-center gap-4 text-center sm:text-left">
                                <div className="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center shrink-0">
                                    <MessageCircle size={24} />
                                </div>
                                <div className="flex-1">
                                    <p className="font-bold text-lg leading-tight uppercase tracking-wide">Comandă Specială?</p>
                                    <p className="text-blue-50 text-xs">Ai nevoie de peste 50 bucăți sau broderie? Contactează-ne!</p>
                                </div>
                                <button
                                    ...
                                    className="bg-white text-blue-600 px-6 py-2.5 rounded-xl font-bold text-sm hover:bg-blue-50 transition-colors shadow-sm active:scale-95"
                                >
                                    Cere Ofertă
                                </button>
                            </div>
