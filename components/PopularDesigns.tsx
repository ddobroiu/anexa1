        ...
        <section className="w-full bg-gradient-to-br from-slate-50 to-white py-12 border-t border-slate-200 mt-12 overflow-hidden">
            <div className="container mx-auto px-4">
                ...
                >
                    {displayProducts.map((product) => (
                        ...
                        >
                            ...
                            <div className="p-4">
                                <h3 className="text-sm font-bold text-slate-900 mb-1 leading-tight group-hover:text-blue-600 transition-colors line-clamp-2 min-h-[2.5em]">
                                    {product.title}
                                </h3>
                ...
                <div className="mt-6 text-center sm:hidden">
                    <Link href="/shop/bannere" className="text-blue-600 font-bold text-sm flex items-center justify-center gap-1">
