...
export default function ProductSchema({
    ...
    const schema: Record<string, unknown> = {
        ...
        "image": typeof window !== "undefined" ? new URL(image, window.location.origin).href : `https://www.Anexa1.ro${image}`,
        ...
        "offers": {
            "@type": "AggregateOffer",
            "url": typeof window !== "undefined" ? new URL(url, window.location.origin).href : `https://www.Anexa1.ro${url}`,
