    ...
    return (
        <div className="bg-slate-50 min-h-screen pb-20">
            ...
            <div className="bg-slate-900 text-white pt-32 pb-16">
                <div className="container mx-auto px-4 text-center">
                    ...
                    <div className="flex justify-center gap-4 flex-wrap">
                        <div className="flex items-center gap-2 text-blue-400 font-bold bg-white/10 px-4 py-2 rounded-full backdrop-blur-sm">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3">
                        ...
                        <div className="relative">
                            ...
                            <select
                                ...
                                className="pl-9 pr-8 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 outline-none w-full sm:w-auto appearance-none bg-white cursor-pointer"
                            >
                                {categories.map(cat => (
            ...
            <div className="container mx-auto px-4 mt-8">
                <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl p-6 sm:p-10 text-white flex flex-col md:flex-row items-center justify-between gap-6 shadow-xl">
                    <div className="text-center md:text-left">
                        <h2 className="text-2xl font-bold mb-2">Nu găsești modelul potrivit?</h2>
                        <p className="text-blue-100">Folosește configuratorul standard și încarcă propria ta grafică sau creează una de la zero.</p>
                    </div>
                    <Link href="/configurator/banner">
                        <button className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 h-11 px-8 bg-white text-blue-700 hover:bg-blue-50 font-bold shadow-md">
                            ...
                            <Link href={`/banner-product/${product.slug}`} key={product.id} className="group flex flex-col bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 hover:-translate-y-1 h-full">
                                ...
                                <div className="p-5 flex flex-col flex-1">
                                    ...
                                    <div className="mt-auto pt-4 border-t border-gray-50 flex items-center justify-between">
                                        ...
                                        <div className="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center text-gray-400 group-hover:bg-blue-600 group-hover:text-white transition-colors">
