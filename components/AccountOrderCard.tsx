...
export default function AccountOrderCard({ order }: AccountOrderCardProps) {
    ...
    return (
        <li className="p-4 sm:p-6 rounded-xl border-2 border-gray-200 bg-white hover:shadow-lg transition-all duration-200 hover:border-blue-400">
            ...
            <div className="flex flex-wrap gap-2 pt-4 border-t border-gray-200">
                <Link
                    ...
                    className="inline-flex items-center justify-center gap-2 rounded-lg bg-blue-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-700 transition-colors flex-1 sm:flex-none"
                >
