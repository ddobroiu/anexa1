    ...
    return (
      <div className="flex gap-1">
        <Button 
          variant="outline" 
          size="sm" 
          className="h-7 w-full bg-blue-500/10 border-blue-500/30 text-blue-400 hover:bg-blue-500/20 text-[10px]"
        >
        ...
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
          ...
          <DialogContent className="bg-[#09090b] border-white/10 text-white">
             ...
             <div className="py-4">
                ...
                {uploading && <p className="text-xs text-blue-400 mt-2 animate-pulse">Se încarcă...</p>}
             </div>
          </DialogContent>
        </Dialog>
      </div>
        ...
        <label 
          ...
          className={`flex items-center justify-center w-full h-7 rounded border text-[10px] font-medium cursor-pointer transition-all
            ${uploading 
              ...
              : 'bg-blue-600/10 border-blue-600/30 text-blue-400 hover:bg-blue-600 hover:text-white hover:border-blue-500'
            }`}
        >
