                        ...
                        >
                            ...
                            <div className="flex-1 min-w-0">
                                <div className="flex items-center gap-2 mb-1">
                                    <span className="shrink-0 inline-flex items-center justify-center h-6 min-w-6 px-1.5 rounded bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 text-xs font-bold">
                                ...
                                <div className="flex items-center gap-2 mt-2">
                                    {item.metadata?.artworkUrl || item.artworkUrl ? (
                                        <div className="inline-flex items-center gap-1.5 text-xs font-medium text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/10 px-2.5 py-1 rounded-md border border-blue-100 dark:border-blue-900/20">
                                            <CheckCircle size={12} />
                                            Fișier recepționat
                                        </div>
                                    ) : (
                                ...
                                <div className="relative">
                                    ...
                                    {artworkUrl ? (
                                        ...
                                        <div className="flex flex-col gap-1">
                                            <label
                                                htmlFor={`upload-${item.id}`}
                                                className="cursor-pointer w-full sm:w-auto inline-flex items-center justify-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white shadow-sm rounded-md text-sm font-medium transition-colors"
                                            >
                                                {uploadingId === item.id ? (
                                                    <>
