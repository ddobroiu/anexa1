                    ...
                    <div className="relative z-10 w-full max-w-4xl max-h-[90vh] flex flex-col overflow-hidden rounded-2xl border border-white/10 bg-slate-950 p-6 shadow-2xl">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 overflow-y-auto">
                            ...
                            <div className="rounded-xl border border-white/10 bg-white/5 p-4">
                                <div className="flex items-center justify-between mb-4">
                                    ...
                                    <Link
                                        ...
                                        className="text-xs bg-blue-600 hover:bg-blue-500 text-white px-3 py-1.5 rounded-lg font-medium flex items-center gap-2 transition-colors"
                                    >
                            ...
                            <div className="rounded-xl border border-white/10 bg-white/5 p-4 h-fit">
                                ...
                                <div className="mt-4">
                                    <div className="text-sm text-slate-300">
                                        <div className="flex justify-between items-center">
                                            ...
                                            <span className={`font-semibold ${order.paymentMethod?.toLowerCase() === 'card' ? 'text-blue-300' : 'text-orange-300'}`}>
                                ...
                                {order.invoiceUrl && (
                                    <a href={order.invoiceUrl} target="_blank" className="mt-4 flex items-center justify-center gap-2 w-full rounded-lg border border-white/10 bg-white/5 py-2 text-sm text-blue-400 hover:bg-white/10 transition-colors">
                                ...
                                {order.awbNumber && (
                                    <a
                                        ...
                                        target="_blank"
                                        className="mt-2 block text-center w-full rounded-lg border border-blue-400 bg-blue-600 py-2 text-sm text-white font-bold hover:bg-blue-500 transition-colors"
                                    >
                                        Urmărește livrarea
                                    </a>
                                )}
