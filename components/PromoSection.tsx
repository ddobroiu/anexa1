...
export default function PromoSection() {
    ...
    const t = (key: string) => {
        const texts: Record<string, string> = {
            ...
            "promo.anexa1.desc": "Echipamente de print și soluții pentru producție publicitară.",
            "promo.randari.desc": "Platformă AI de randări. Transformăm schițele în simulări 3D spectaculoase.",
            "promo.prynt.desc": "Cea mai mare tipografie online din România pentru printuri personalizate.",
        };
        return texts[key] || key;
    };

    const components = [
        { id: "anexa1", component: <MainShopCard t={t} /> },
    ...
    return (
        <section id="portofoliu" className="relative py-24 overflow-hidden bg-slate-950">
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-[500px] bg-blue-500/10 blur-[120px] rounded-full pointer-events-none -z-10" />
            ...
            <div className="max-w-7xl mx-auto px-4 relative z-10">
                <div className="text-center mb-16">
                    ...
                    >
                        <span className="inline-block px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-[0.7rem] font-bold text-blue-400 uppercase tracking-widest mb-4">
                            {t("promo.badge")}
                        </span>
                ...
                <div className="relative group">
                    ...
                    <button
                        onClick={prevSlide}
                        className="absolute left-0 lg:-left-12 top-1/2 -translate-y-1/2 p-4 rounded-full bg-white/5 border border-white/10 text-white hover:bg-white/10 hover:border-blue-400 transition-all z-20 backdrop-blur-md opacity-0 group-hover:opacity-100 hidden md:block"
                    >
                        <ArrowLeft size={24} />
                    </button>
                    ...
                    <button
                        onClick={nextSlide}
                        className="absolute right-0 lg:-right-12 top-1/2 -translate-y-1/2 p-4 rounded-full bg-white/5 border border-white/10 text-white hover:bg-white/10 hover:border-blue-400 transition-all z-20 backdrop-blur-md opacity-0 group-hover:opacity-100 hidden md:block"
                    >
                        <ArrowRight size={24} />
                    </button>
    ...
    return (
        ...
        >
            <div className="p-8">
                ...
                <div className="text-2xl font-bold text-white mb-3 tracking-tight">Anexa1.ro</div>
                <div className="text-slate-300 text-sm leading-relaxed mb-6">{t("promo.anexa1.desc")}</div>
            </div>
            <div className="bg-[#0f1612] h-48 border-t border-white/5 relative overflow-hidden flex items-center justify-center">
                <motion.div
                    ...
                    className="text-blue-500/20 font-black text-6xl"
                >
                    ANEXA1
                </motion.div>
    ...
    return (
        ...
        >
            ...
            <div className="bg-black/50 p-6 font-mono text-xs border-t border-white/5 h-48 flex flex-col justify-end gap-2">
                <div className="text-blue-400">➜ npm run deploy</div>
