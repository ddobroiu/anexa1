        ...
        <div className="py-6 space-y-8">
            <div className="space-y-4">
                ...
                {state.designOption === 'upload' && (
                    <div className="mt-4">
                        <label className="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-200 border-dashed rounded-xl cursor-pointer hover:border-blue-500 transition-colors bg-slate-50 dark:bg-slate-800">
                ...
                {state.designOption === 'text_only' && (
                    <textarea
                        ...
                        className="w-full h-24 p-4 rounded-xl border-2 border-slate-100 bg-slate-50 font-bold text-sm outline-none focus:border-blue-600 transition-all placeholder:text-slate-300"
