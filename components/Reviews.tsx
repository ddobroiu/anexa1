      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-slate-100 pb-8">
          <div>
            <h3 className="text-2xl font-black text-slate-900 tracking-tight flex items-center gap-3">
              <Star className="text-blue-500 fill-blue-500 h-6 w-6" />
              Recenzii Verificate
            </h3>
             ...
             <div className="sticky top-32">
                  {session?.user ? (
                    <form onSubmit={handleSubmit} className="bg-slate-50 border border-slate-200/60 rounded-3xl p-6 md:p-8 relative overflow-hidden group">
                      <div className="absolute top-0 right-0 w-32 h-32 bg-blue-500/10 rounded-full blur-[40px] group-hover:bg-blue-500/20 transition-colors pointer-events-none"></div>
                      ...
                      <div className="space-y-5 relative z-10">
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                className="w-full bg-white border border-slate-200 text-slate-900 placeholder:text-slate-400 h-12 rounded-xl px-4 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none"
                            />
                        </div>
                        ...
                        <div>
                            ...
                            <textarea 
                                ...
                                rows={4} 
                                className="w-full bg-white border border-slate-200 text-slate-900 placeholder:text-slate-400 rounded-xl p-4 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none resize-none" 
                                required 
                            />
                        </div>
                        ...
                        <button 
                            type="submit" 
                            disabled={submitting} 
                            className="w-full bg-blue-500 hover:bg-blue-400 text-white hover:text-slate-950 h-14 rounded-xl text-sm font-black uppercase tracking-widest transition-all shadow-[0_0_20px_rgba(16,185,129,0.2)] hover:shadow-[0_0_30px_rgba(16,185,129,0.4)] disabled:opacity-50 disabled:cursor-not-allowed mt-2"
                        >
                    ...
                    <div className="bg-slate-50 border border-slate-200/60 rounded-3xl p-8 text-center flex flex-col items-center justify-center min-h-[300px]">
                        ...
                        <a href="/login" className="px-8 py-3 bg-slate-900 hover:bg-blue-500 text-white rounded-xl text-sm font-bold transition-colors shadow-lg shadow-slate-900/10">
                            Intră în cont
                        </a>
                    </div>
                  )}
                        ...
                        <div key={review.id} className="p-6 md:p-8 bg-white border border-slate-100 rounded-3xl shadow-sm hover:shadow-md transition-shadow">
                            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
                                <div className="flex items-center gap-4">
                                    {review.user.image ? (
                                        <img src={review.user.image} alt={review.user.name || ''} className="w-12 h-12 rounded-full ring-4 ring-blue-50" />
                                    ) : (
                                    ...
                                    <div>
                                        ...
                                        <span className="text-xs font-bold text-blue-600 bg-blue-50 px-2 py-0.5 rounded-md mt-1 inline-flex uppercase tracking-wider">Achițizie Verificată</span>
                                    </div>
                                </div>
