            ...
            <div className="container mx-auto px-4 py-8 lg:py-12">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    ...
                    ${selectedSize === size.id
                                    ...
                                    >
                                        <div>
                                            <div className={`font-bold ${selectedSize === size.id ? "text-blue-700" : "text-slate-900 dark:text-white"}`}>
                                                {size.label}
                                            </div>
                        ...
                        <div className="bg-white border-t border-gray-100 pt-6">
                            ...
                            <div className="flex flex-col gap-3">
                                <button
                                    ...
                                    className="w-full py-4 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl text-lg shadow-[0_20px_50px_-12px_rgba(0,0,0,0.05)] shadow-blue-600/20 transition-all active:scale-[0.98] flex items-center justify-center gap-2"
                                >
