                ...
                <div className="flex flex-col lg:flex-row gap-8 items-start">
                    ...
                    <div className="w-full lg:w-1/2 flex flex-col gap-6">
                        <div className="bg-white rounded-3xl p-8 shadow-xl shadow-slate-200/50 border border-slate-100">
                            <div className="mb-6">
                                <span className="inline-block px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-[10px] font-black uppercase tracking-widest mb-3">Produs în Stoc</span>
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            <div className="flex justify-between items-center mb-1">
                                                                <span className="font-black text-slate-900 dark:text-white text-sm group-hover:text-blue-600 transition-colors">{sizeLabel}</span>
                                                                {selectedVariantIndex === vIndex && <Check size={16} className="text-blue-500" />}
                                                            </div>
                                        ...
                                        {DIMENSIONS.map((dim) => (
                                            ...
                                            >
                                                <div className="flex justify-between items-center mb-1">
                                                    ...
                                                    {selectedDim.value === dim.value && <Check size={16} className="text-blue-500" />}
                                                </div>
                                                {dim.multiplier > 1 ? (
                        ...
                        <div className="bg-white/80 backdrop-blur-xl rounded-3xl p-6 shadow-2xl border border-white/20 flex flex-col sm:flex-row items-center justify-between gap-6 sticky bottom-4 z-40">
                            ...
                            <button
                                ...
                                className="w-full sm:w-auto px-10 py-5 bg-blue-500 hover:bg-blue-600 text-white font-black rounded-2xl shadow-lg shadow-blue-500/30 hover:shadow-blue-500/50 hover:-translate-y-1 transition-all flex items-center justify-center gap-3 text-lg"
                            >
