...
export const AccordionStep = ({
    ...
    <div className="relative pl-12">
        <div className="absolute top-5 left-0 flex flex-col items-center h-full">
            <span className={`flex items-center justify-center w-8 h-8 rounded-full text-md font-bold transition-colors ${isOpen ? 'bg-blue-500 text-white' : 'bg-slate-200 text-slate-700 dark:text-slate-300'}`}>
                {stepNumber}
            </span>
