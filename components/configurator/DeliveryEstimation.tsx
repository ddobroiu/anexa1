...
export default function DeliveryEstimation({ county }: Props) {
    ...
    return (
        <div className="text-xs sm:text-sm flex items-center gap-1.5 bg-gradient-to-r from-blue-50 to-teal-50 border border-blue-300 rounded-lg px-2 py-1.5 shadow-sm h-full whitespace-nowrap">
            <Truck className="w-4 h-4 text-blue-600 shrink-0" strokeWidth={2.5} />
            <span className="text-slate-900 dark:text-white font-semibold">Livrare:</span>
            {loading ? (
