                            ...
                            <AccordionStep stepNumber={2} title="Material & Grosime" summary={summaryStep2} isOpen={activeStep === 2} onClick={() => setActiveStep(2)}>
                                ...
                                {input.material === "transparent" && (
                                    <label className="flex items-center gap-3 py-2 cursor-pointer">
                                        <input type="checkbox" className="w-5 h-5 rounded border-gray-300 text-slate-950 focus:ring-blue-500" checked={input.print_double} onChange={(e) => updateInput("print_double", e.target.checked)} />
                                                    ...
                                                    <div className="grid grid-cols-3 gap-2">
                                                        {(["13x13", "15x25", "25x25"] as const).map((k) => (
                                                            <button
                                                                ...
                                                                className={`py-2 text-xs font-bold border-2 rounded-lg transition-all ${input.standoffs?.size === k ? "border-blue-600 bg-blue-50 text-blue-700" : "border-gray-200 dark:border-slate-800 bg-white hover:border-gray-300"}`}
                                                            >
                                                                {k}
                                                            </button>
                                                        ))}
                                    ...
                                    {isFromShop ? (
                                        <div className="p-4 bg-slate-50 dark:bg-slate-800 border border-slate-200 rounded-xl mb-4">
                                            <div className="flex items-center gap-4 mb-4">
                                                ...
                                                <div>
                                                    <span className="inline-block px-2 py-0.5 rounded bg-blue-100 text-blue-500 text-xs font-bold mb-1">MODEL SELECTAT</span>
