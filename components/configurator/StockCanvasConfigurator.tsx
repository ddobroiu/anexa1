    ...
    if (!product) {
        return (
            <div className="container mx-auto px-4 py-20 text-center">
                ...
                <Link href="/configurator/canvas" className="text-blue-600 hover:underline mt-4 inline-block">
                    Înapoi la colecție
                </Link>
            </div>
        );
            ...
            <div className={`w-full max-w-full box-border ${renderOnlyConfigurator ? '' : 'container mx-auto px-4 py-4'}`}>
                {!renderOnlyConfigurator && (
                    <nav className="flex items-center gap-2 text-sm text-gray-500 mb-6">
                        ...
                        <Link href="/configurator/canvas" className="hover:text-blue-600">Shop / Canvas</Link>
                        <ChevronRight size={14} />
                        ...
                        <div className="pb-4 border-b border-gray-100">
                            <div className="flex border-b border-gray-100 bg-slate-50 dark:bg-slate-800/50">
                                <button
                                    ...
                                    className={`flex-1 py-3 text-sm font-bold flex items-center justify-center gap-2 transition-colors ${viewMode === 'gallery' ? 'text-blue-600 bg-white border-b-2 border-blue-600 shadow-sm' : 'text-gray-500 hover:text-gray-700 dark:text-gray-300'}`}
                                >
                                    <ImageIcon size={18} /> Foto
                                </button>
                                <button
                                    onClick={() => setViewMode('3d')}
                                    className={`flex-1 py-3 text-sm font-bold flex items-center justify-center gap-2 transition-colors ${viewMode === '3d' ? 'text-blue-600 bg-white border-b-2 border-blue-600 shadow-sm' : 'text-gray-500 hover:text-gray-700 dark:text-gray-300'}`}
                                >
                                ...
                                {viewMode === 'gallery' ? (
                                    <div className="w-full h-full relative group">
                                        ...
                                        <div className="absolute top-4 left-4">
                                            <span className="bg-white/90 backdrop-blur-md text-blue-700 px-4 py-1.5 rounded-full text-xs font-bold shadow-sm flex items-center gap-1.5 border border-blue-100">
                                                <Sparkles size={14} />
                                                CALITATE PREMIUM
                                            </span>
                                        </div>
                                    ...
                                    <div className="w-full h-full bg-slate-50 dark:bg-slate-800 flex items-center justify-center relative group/viewer">
                                        ...
                                        >
                                            <button
                                                ...
                                                className={`absolute bottom-4 left-4 font-bold py-2 px-4 rounded-full shadow-[0_20px_50px_-12px_rgba(0,0,0,0.05)] flex items-center gap-2 transition-transform active:scale-95 z-20 ${!isTextureLoaded ? 'bg-gray-400 cursor-not-allowed opacity-70 text-gray-100' : 'bg-blue-600 hover:bg-blue-700 text-white'}`}
                                            >
                        ...
                        {!renderOnlyConfigurator && (
                            <header className="mb-6">
                                ...
                                <div className="flex justify-between items-center">
                                    ...
                                    <span className="text-xs text-blue-600 font-bold flex items-center gap-1 bg-blue-50 px-2 py-1 rounded">
                        ...
                        <div className="bg-white rounded-2xl shadow-[0_20px_50px_-12px_rgba(0,0,0,0.05)] border border-gray-200 dark:border-slate-800 p-6 mb-8 space-y-8">
                            ...
                            <div className="pb-6 border-b border-gray-100 flex flex-wrap items-center justify-between gap-4">
                                ...
                                <Link
                                    ...
                                    className="flex items-center gap-1.5 px-3 py-1.5 bg-blue-50 text-blue-700 rounded-lg text-xs font-bold hover:bg-blue-100 transition-colors border border-blue-100 group"
                                >
