                        ...
                        <div className="bg-white rounded-2xl shadow-[0_20px_50px_-12px_rgba(0,0,0,0.05)] border border-gray-200 dark:border-slate-800 px-4 mb-8">
                            <AccordionStep stepNumber={1} title="Hârtie & Tiraj" summary={summaryStep1} isOpen={activeStep === 1} onClick={() => setActiveStep(1)}>
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                                        ...
                                        <div className="grid grid-cols-3 gap-2">
                                            {(["115", "135", "150", "170", "200", "250"] as PlianteWeightKey[]).map((w) => (
                                                <button
                                                    key={w}
                                                    onClick={() => setWeight(w)}
                                                    className={`py-2 text-xs font-bold border-2 rounded-lg transition-all ${weight === w ? "border-blue-600 bg-blue-50 text-blue-700" : "border-gray-200 dark:border-slate-800 bg-white hover:border-gray-300"}`}
                                                >
                                                    {w}g
                                                </button>
                                            ))}
                                    ...
                                    {upsellData && (
                                        <div
                                            className="mt-3 p-3 sm:p-4 bg-blue-50 border border-blue-200 rounded-lg cursor-pointer hover:bg-blue-100 transition-colors flex gap-3 items-center group relative w-full col-span-1 sm:col-span-2"
                                        ...
                                        >
                                            ...
                                            <div className="ml-auto flex flex-col items-end gap-2 shrink-0">
                                                <div className="flex items-center justify-center bg-white rounded-md px-2 py-0.5 shadow-sm border border-blue-100">
                                                    <span className="text-xs font-bold text-blue-600">-{upsellData.discountPercent}%</span>
                                                </div>
