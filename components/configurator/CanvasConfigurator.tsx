        ...
        <main className="bg-slate-50 dark:bg-slate-800 min-h-screen">
                        ...
                        <div className="bg-white rounded-2xl shadow-[0_20px_50px_-12px_rgba(0,0,0,0.05)] border border-gray-200 dark:border-slate-800 overflow-hidden">
                            ...
                            <div className="flex border-b border-gray-100 overflow-x-auto">
                                ...
                                <button
                                    ...
                                    className={`flex-1 py-3 min-w-20 text-sm font-medium flex items-center justify-center gap-2 transition-colors ${viewMode === '3d' ? 'text-blue-600 bg-blue-50 border-b-2 border-blue-600' : 'text-gray-500 hover:bg-slate-50 dark:bg-slate-800'}`}
                                >
                            ...
                            <div className="aspect-square relative bg-white">
                                {viewMode === 'gallery' ? (
                                    ...
                                    <div className="w-full h-full bg-slate-50 dark:bg-slate-800 flex items-center justify-center relative group/viewer">
                                        ...
                                        >
                                            <button slot="ar-button" className="absolute bottom-4 left-4 bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full shadow-[0_20px_50px_-12px_rgba(0,0,0,0.05)] flex items-center gap-2 transition-transform active:scale-95 z-20">
                                                <Box size={18} />
                                                Vezi în AR
                                            </button>
                                        {/* @ts-ignore */}
                                        ...
                                        {!artworkUrl && (
                                            <div className="absolute inset-0 bg-slate-50 dark:bg-slate-800/80 backdrop-blur-[4px] z-30 flex flex-col items-center justify-center p-6 text-center">
                                                ...
                                                <button
                                                    ...
                                                    className="mt-6 px-6 py-2.5 bg-blue-600 text-white font-bold rounded-xl shadow-[0_20px_50px_-12px_rgba(0,0,0,0.05)] hover:bg-blue-700 transition-all active:scale-95 text-sm"
                                                >
                                                    ÎNCARCĂ POZA ACUM
                                                </button>
                                            </div>
                                        ...
                                        <div className="absolute bottom-4 right-4 z-20 hidden lg:block">
                                            <div className="bg-white/95 backdrop-blur-xl p-3 rounded-2xl border-2 border-blue-100 shadow-[0_8px_32px_rgba(0,0,0,0.12)] group/qr transition-all hover:scale-105 hover:border-blue-300">
                                                <div className="flex flex-col items-center gap-2">
                                                    ...
                                                    <div className="text-center">
                                                        <div className="text-[9px] font-black text-blue-600 uppercase tracking-widest">Vezi în AR</div>
                                        ...
                                        <div className="mb-4">
                                            ...
                                            <div className="grid grid-cols-3 gap-2">
                                                <button
                                                    ...
                                                    className={`p-3 rounded-lg border-2 flex flex-col items-center gap-2 transition-all ${orientation === 'portrait' ? 'border-blue-600 bg-blue-50 text-blue-700' : 'border-slate-200 hover:border-slate-300'}`}
                                                >
                                                ...
                                                <button
                                                    ...
                                                    className={`p-3 rounded-lg border-2 flex flex-col items-center gap-2 transition-all ${orientation === 'landscape' ? 'border-blue-600 bg-blue-50 text-blue-700' : 'border-slate-200 hover:border-slate-300'}`}
                                                >
                                                ...
                                                <button
                                                    ...
                                                    className={`p-3 rounded-lg border-2 flex flex-col items-center gap-2 transition-all ${orientation === 'square' ? 'border-blue-600 bg-blue-50 text-blue-700' : 'border-slate-200 hover:border-slate-300'}`}
                                                >
                                ...
                                {input.frameType === "none" && upsellOpportunity && (
                                    ...
                                    >
                                        ...
                                        <div className="flex-1">
                                            <p className="text-sm text-blue-900 font-bold">Reducere de Volum!</p>
            ...
            {showArAutoLaunch && (
                <div className="fixed inset-0 z-[100] bg-black/90 backdrop-blur-md flex flex-col items-center justify-center p-6 text-center text-white">
                    <div className="w-24 h-24 bg-blue-600 rounded-full flex items-center justify-center shadow-[0_0_30px_rgba(16,185,129,0.4)] mb-8 animate-pulse">
                        <Box size={48} />
                    </div>
                    ...
                    <button
                        ...
                        className={`w-full max-w-xs py-4 font-black rounded-2xl shadow-xl transition-all flex items-center justify-center gap-3 text-lg ${!isArtLoaded ? 'bg-gray-600 cursor-not-allowed opacity-50' : 'bg-blue-600 hover:bg-blue-700 active:scale-95 text-white'}`}
                    >
                        {
