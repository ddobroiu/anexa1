                                    ...
                                    <div>
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                                            <button
                                                ...
                                                className={`p-3 border-2 rounded-xl text-left transition-all ${input.print_type === "print_cut" ? "border-blue-600 bg-blue-50" : "border-gray-200 dark:border-slate-800 hover:border-blue-200"}`}
                                            >
                                            ...
                                            <button
                                                ...
                                                className={`p-3 border-2 rounded-xl text-left transition-all ${input.print_type === "print_only" ? "border-blue-600 bg-blue-50" : "border-gray-200 dark:border-slate-800 hover:border-blue-200"}`}
                                            >
                                                <p className="font-bold text-slate-900 dark:text-white text-sm">Doar Print</p>
                                                <p className="text-xs text-gray-500 text-blue-600 font-medium">Reducere -20%</p>
                                            </button>
                                        </div>
                                    </div>
