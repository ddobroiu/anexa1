...
export default function ConfiguratorCartiVizita({ productImage }: { productImage?: string }) {
    ...
    function handleAddToCart() {
        ...
        const title = `Cărți de Vizită - ${matLabels[input.type]}`;
        ...
        addItem({
            ...
            metadata: {
                ...
                ...(input.designOption === "upload" && artworkUrl ? fitMetadata(9, 5, artworkPx, artworkFit) : {}),
            },
        });
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
                            ...
                            <div className="p-2 grid grid-cols-4 gap-2 border-t border-gray-100">
                                {GALLERY.map((src, i) => (
                                    <button
                                        ...
                                        className={`relative rounded-lg aspect-square overflow-hidden border-2 transition-all ${activeIndex === i ? "border-blue-600 shadow-md scale-105" : "border-transparent opacity-70 hover:opacity-100"}`}
                                    >
                    ...
                    <div>
                        ...
                        <div className="bg-white rounded-2xl shadow-[0_20px_50px_-12px_rgba(0,0,0,0.05)] border border-gray-200 dark:border-slate-800 px-4 mb-8">
                            <AccordionStep stepNumber={1} title="Cantitate" summary={summaryStep1} isOpen={activeStep === 1} onClick={() => setActiveStep(1)}>
                                <div className="mb-4">
                                ...
                                {upsellOpportunity && (
                                    <div
                                        className="mt-3 p-3 sm:p-4 bg-blue-50 border border-blue-200 rounded-lg cursor-pointer hover:bg-blue-100 transition-colors flex gap-3 items-center group relative w-full"
                            ...
                            <AccordionStep stepNumber={2} title="Material și Finisaje" summary={summaryStep2} isOpen={activeStep === 2} onClick={() => setActiveStep(2)}>
                                ...
                                <div className="space-y-4 pt-4 border-t border-gray-100">
                                    <label className={`flex items-center gap-3 p-3 rounded-xl border cursor-pointer transition-all ${input.twoSided ? 'bg-blue-50 border-blue-200' : 'bg-slate-50 dark:bg-slate-800 border-gray-200 dark:border-slate-800 hover:bg-gray-100'}`}>
                                        <input type="checkbox" className="w-5 h-5 rounded border-gray-300 text-blue-600 focus:ring-blue-500" checked={input.twoSided} onChange={(e) => updateInput("twoSided", e.target.checked)} />
                                        <div>
                                    ...
                                    <label className={`flex items-center gap-3 p-3 rounded-xl border cursor-pointer transition-all ${input.roundedCorners ? 'bg-blue-50 border-blue-200' : 'bg-slate-50 dark:bg-slate-800 border-gray-200 dark:border-slate-800 hover:bg-gray-100'}`}>
                                        <input type="checkbox" className="w-5 h-5 rounded border-gray-300 text-blue-600 focus:ring-blue-500" checked={input.roundedCorners} onChange={(e) => updateInput("roundedCorners", e.target.checked)} />
                                        <div>
                                    ...
                                    <label className={`flex items-center gap-3 p-3 rounded-xl border cursor-pointer transition-all ${input.specialShape ? 'bg-blue-50 border-blue-200' : 'bg-slate-50 dark:bg-slate-800 border-gray-200 dark:border-slate-800 hover:bg-gray-100'}`}>
                                        <input type="checkbox" className="w-5 h-5 rounded border-gray-300 text-blue-600 focus:ring-blue-500" checked={input.specialShape} onChange={(e) => updateInput("specialShape", e.target.checked)} />
                                        <div>
                        ...
                        {activeProductTab === 'descriere' && (
                            <div className="prose dark:prose-invert max-w-none text-gray-700 dark:text-gray-300 text-sm sm:text-base">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    <div>
                                        <h3 className="text-xl font-bold text-blue-900 mb-3">Materiale Neconvenționale</h3>
                                    ...
                                    <div>
                                        <h3 className="text-xl font-bold text-blue-900 mb-3">Finisaje Optionale</h3>
