    ...
    return (
        <main className="bg-slate-50 dark:bg-slate-800 min-h-screen">
            <ProductJsonLd
                ...
                url={typeof window !== 'undefined' ? window.location.href : "https://www.Anexa1.ro/configurator/autocolante"}
            />
                        ...
                        <div className="bg-white rounded-2xl shadow-[0_20px_50px_-12px_rgba(0,0,0,0.05)] border border-gray-200 dark:border-slate-800 px-4 mb-8">
                            ...
                            <AccordionStep stepNumber={2} title="Material & Tip Print" summary={summaryStep2} isOpen={activeStep === 2} onClick={() => setActiveStep(2)}>
                                ...
                                <label className="flex items-center gap-3 p-3 border-2 rounded-lg cursor-pointer hover:bg-slate-50 dark:bg-slate-800 transition-colors">
                                    <input type="checkbox" className="w-5 h-5 rounded text-blue-600 focus:ring-blue-500" checked={input.laminated} onChange={(e) => updateInput("laminated", e.target.checked)} />
                                    <div>
                                ...
                                <label className="mt-2 flex items-center gap-3 p-3 border-2 rounded-lg cursor-pointer hover:bg-slate-50 dark:bg-slate-800 transition-colors">
                                    <input type="checkbox" className="w-5 h-5 rounded text-blue-600 focus:ring-blue-500" checked={input.transfer_film} onChange={(e) => updateInput("transfer_film", e.target.checked)} />
                                    <div>
                                ...
                                <div>
                                    ...
                                    {input.designOption === 'text_only' && (
                                        <div className="space-y-3">
                                            ...
                                            <textarea className="w-full p-4 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all shadow-sm text-base min-h-24 text-gray-800 bg-white" rows={3} value={textDesign} onChange={e => setTextDesign(e.target.value)} placeholder="Ex: ETICHETA PRODUS, PROMOȚIE, etc."></textarea>
                                        </div>
                                    )}
