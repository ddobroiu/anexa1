...
const AccordionStep = ({ stepNumber, title, summary, isOpen, onClick, children, isLast = false }: { stepNumber: number; title: string; summary: string; isOpen: boolean; onClick: () => void; children: React.ReactNode; isLast?: boolean; }) => (
    <div className="relative pl-12">
        <div className="absolute top-5 left-0 flex flex-col items-center h-full">
            <span className={`flex items-center justify-center w-8 h-8 rounded-full text-md font-bold transition-colors ${isOpen ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700 dark:text-gray-300'}`}>{stepNumber}</span>
    ...
    return (
        <div className="inline-flex flex-wrap gap-1 rounded-lg border border-gray-300 bg-white p-1 shadow-sm">
            <Link
                ...
                className={`px-3 sm:px-4 py-1.5 rounded-md text-xs sm:text-sm font-semibold transition-all inline-flex items-center justify-center ${isFace ? "bg-blue-600 text-white shadow-md" : "text-gray-600 dark:text-gray-400 hover:bg-slate-50 dark:hover:bg-slate-800"}`}
            >
                O față
            </Link>
            <Link
                href="/configurator/banner-verso"
                className={`px-3 sm:px-4 py-1.5 rounded-md text-xs sm:text-sm font-semibold transition-all inline-flex items-center justify-center ${isVerso ? "bg-blue-600 text-white shadow-md" : "text-gray-600 dark:text-gray-400 hover:bg-slate-50 dark:hover:bg-slate-800"}`}
            >
                Față-verso
            </Link>
            <Link
                href="/configurator/mesh"
                className={`px-3 sm:px-4 py-1.5 rounded-md text-xs sm:text-sm font-semibold transition-all inline-flex items-center justify-center ${isMesh ? "bg-blue-600 text-white shadow-md" : "text-gray-600 dark:text-gray-400 hover:bg-slate-50 dark:hover:bg-slate-800"}`}
            >
                Mesh
            </Link>
        </div>
    ...
    return (
        <button
            ...
            className={`w-full text-left p-4 rounded-xl border-2 transition-all duration-200 ${active
                ? "border-slate-950 bg-blue-50/50 ring-1 ring-slate-950 shadow-md"
                : "border-gray-200 dark:border-slate-800 bg-white hover:border-gray-300 hover:bg-slate-50 dark:bg-slate-800"
                }`}
        >
            <div className={`font-bold transition-colors ${active ? "text-blue-500" : "text-gray-800"}`}>{title}</div>
...
function TabButton({ active, onClick, children }: { active: boolean; onClick: () => void; children: React.ReactNode; }) {
    return <button type="button" onClick={onClick} className={`px-4 py-2 text-sm font-semibold transition-colors rounded-t-lg ${active ? "border-b-2 border-slate-950 text-slate-950 bg-blue-50" : "text-gray-500 hover:text-gray-800"}`}>{children}</button>;
}
                        ...
                        <div className="bg-white rounded-2xl shadow-[0_20px_50px_-12px_rgba(0,0,0,0.05)] border border-gray-200 dark:border-slate-800 overflow-hidden">
                            ...
                            <div className="flex border-b border-gray-100 overflow-x-auto">
                                <button
                                    ...
                                    className={`flex-1 py-3 min-w-20 text-sm font-medium flex items-center justify-center gap-2 transition-colors ${viewMode === 'gallery' ? 'text-blue-600 bg-blue-50 border-b-2 border-blue-600' : 'text-gray-500 hover:bg-slate-50 dark:bg-slate-800'}`}
                                >
                                    <ImageIcon size={16} />
                                ...
                                <button
                                    ...
                                    className={`flex-1 py-3 min-w-20 text-sm font-medium flex items-center justify-center gap-2 transition-colors ${viewMode === 'shape' ? 'text-blue-600 bg-blue-50 border-b-2 border-blue-600' : 'text-gray-500 hover:bg-slate-50 dark:bg-slate-800'}`}
                                >
                                    <Ruler size={16} />
                                ...
                                <div className="p-2 grid grid-cols-4 gap-2 border-t border-gray-100">
                                    {galleryImages.map((src, i) => (
                                        <button
                                            ...
                                            className={`relative rounded-lg aspect-square overflow-hidden ${activeIndex === i && !artworkUrl ? "ring-2 ring-offset-2 ring-blue-500" : "hover:opacity-80"}`}
                                        >
                                            <Image 
                                                src={src} 
                                                alt="Miniatura" 
                    ...
                    <div className={`${renderOnlyConfigurator ? 'w-full' : 'px-4 sm:px-0 w-full'}`}>
                        ...
                        <div className="bg-white rounded-xl sm:rounded-2xl shadow-[0_20px_50px_-12px_rgba(0,0,0,0.05)] border border-gray-200 dark:border-slate-800 px-3 sm:px-4">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            placeholder="200"
                                            className="w-full p-4 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all shadow-sm text-lg font-medium bg-white text-slate-900"
                                        />
                                    </div>
                                    <div>
                            ...
                            <AccordionStep stepNumber={2} title="Material & Finisaje" summary={summaryStep2} isOpen={activeStep === 2} onClick={() => setActiveStep(2)}>
                                {productKind === "mesh" ? (
                                    <>
                                        <div className="mb-4 p-3 sm:p-4 bg-blue-50/60 dark:bg-blue-950/25 border border-blue-200 dark:border-blue-800 rounded-lg">
                                    ...
                                    {productImage ? (
                                            ...
                                            <div className="border-t border-slate-200 pt-3">
                                                ...
                                                <div className="flex gap-2">
                                                    <button
                                                        ...
                                                        className={`flex-1 py-2 px-3 rounded-lg border text-sm font-semibold transition-colors ${input.designOption === 'upload' ? 'bg-blue-600 text-white border-blue-600' : 'bg-white border-gray-300 text-gray-700 dark:text-gray-300 hover:bg-slate-50 dark:bg-slate-800'}`}
                                                    >
                                                        Încărcare Fișier
                                                    </button>
                                                    <button
                                                        onClick={() => { setArtworkUrl(null); updateInput("designOption", "text_only"); }}
                                                        className={`flex-1 py-2 px-3 rounded-lg border text-sm font-semibold transition-colors ${input.designOption === 'text_only' ? 'bg-blue-600 text-white border-blue-600' : 'bg-white border-gray-300 text-gray-700 dark:text-gray-300 hover:bg-slate-50 dark:bg-slate-800'}`}
                                                    >
                                                        Doar Text
                                                    </button>
                                                </div>
                                                ...
                                                <div className="mt-4 pt-4 border-t border-slate-200 animate-fade-in-up">
                                                    ...
                                                    {input.designOption === 'text_only' && (
                                                        <div className="space-y-3">
                                                            ...
                                                            <textarea className="w-full p-4 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all shadow-sm text-base min-h-24 text-gray-800 bg-white" rows={3} value={textDesign} onChange={e => setTextDesign(e.target.value)} placeholder="Ex: NOUL TEXT AICI..."></textarea>
                                                        </div>
                                                    )}
                                                </div>
                                            )}
                                        ...
                                        <>
                                            <div className="flex -mb-px overflow-x-auto no-scrollbar">
                                                ...
                                                <TabButton active={input.designOption === 'pro'} onClick={() => { setArtworkUrl(null); updateInput("designOption", 'pro'); }}>Vreau Grafică</TabButton>
                                                <Link 
                                            ...
                                            {input.designOption === 'text_only' && (
                                                <div className="space-y-3">
                                                    ...
                                                    <textarea className="w-full p-4 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all shadow-sm text-base min-h-24 text-gray-800 bg-white touch-manipulation" rows={3} value={textDesign} onChange={e => setTextDesign(e.target.value)} placeholder="ex: PROMOTIE, REDUCERI, etc."></textarea>
                                                </div>
                                            )}

                                            {input.designOption === 'pro' && (
                                                <div className="p-3 sm:p-4 rounded-lg bg-blue-50 border border-blue-200 text-xs sm:text-sm text-blue-800">
                        ...
                        <div className="relative bg-white border lg:rounded-2xl lg:shadow-[0_20px_50px_-12px_rgba(0,0,0,0.05)] border-gray-200 dark:border-slate-800 p-3 sm:p-4 lg:p-6 mt-8 mb-24 lg:mb-0">
                            <div className="flex flex-col gap-3">
                                <button onClick={handleAddToCart} className="w-full py-4 text-lg font-bold bg-blue-600 text-white rounded-xl shadow-xl hover:bg-blue-700 transition-all flex items-center justify-center gap-2 active:scale-95 shadow-blue-500/20">
                        ...
                        <div className="fixed bottom-0 left-0 right-0 z-[100] lg:hidden bg-white/95 backdrop-blur-md border-t border-slate-200 p-4 pb-safe animate-in slide-in-from-bottom duration-300 shadow-[0_-10px_25px_-5px_rgba(0,0,0,0.1)]">
                            <div className="flex items-center justify-between gap-4 max-w-md mx-auto">
                                ...
                                <button 
                                    ...
                                    className="flex-1 bg-blue-600 hover:bg-blue-700 text-white font-bold py-3.5 px-4 rounded-xl shadow-lg shadow-blue-600/20 flex items-center justify-center gap-2 active:scale-[0.98] transition-all text-sm"
                                >
                        ...
                        <div className="mt-4 lg:mt-6 bg-gradient-to-br from-slate-50 to-gray-100 dark:from-slate-800 dark:to-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 p-4">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                <a
                                    ...
                                    className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-green-600 to-blue-600 hover:from-green-700 hover:to-blue-700 text-white font-semibold py-2.5 px-4 rounded-lg shadow-md hover:shadow-[0_20px_50px_-12px_rgba(0,0,0,0.05)] transition-all duration-200"
                                >
                            ...
                            <>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 pb-6 border-b border-gray-200 dark:border-slate-800">
                                    <div className="flex items-start gap-4">
                                        <div className="shrink-0 w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center shadow-[0_20px_50px_-12px_rgba(0,0,0,0.05)]">
                                    ...
                                    <div className="flex items-start gap-4">
                                        <div className="shrink-0 w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500 to-teal-600 flex items-center justify-center shadow-[0_20px_50px_-12px_rgba(0,0,0,0.05)]">
                                            <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div className="bg-blue-50 rounded-xl p-6 sm:p-8 border border-blue-100 flex flex-col md:flex-row items-center gap-6 justify-between mt-8">
                                    <div className="flex-1 text-center md:text-left">
                                        <h4 className="text-blue-900 text-xl font-black mb-2 flex items-center justify-center md:justify-start gap-3">
                                    ...
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="shrink-0 flex items-center gap-3 px-8 py-4 bg-blue-600 text-white rounded-2xl font-black text-lg shadow-xl shadow-blue-500/20 hover:bg-blue-700 hover:-translate-y-1 transition-all uppercase tracking-wider"
                                    >
