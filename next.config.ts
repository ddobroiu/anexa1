    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' *.google-analytics.com *.googletagmanager.com *.googleadservices.com *.googlesyndication.com *.doubleclick.net connect.facebook.net; style-src 'self' 'unsafe-inline' fonts.googleapis.com; img-src 'self' blob: data: res.cloudinary.com images.unsplash.com poze.prynt.ro *.r2.dev shop.printcenter.ro www.printcenter.ro dotcomcanvas.de *.hotnews.ro hotnews.ro *.replicate.delivery replicate.delivery pbxt.replicate.delivery *.google-analytics.com *.googletagmanager.com *.googlesyndication.com *.googleadservices.com *.doubleclick.net *.google.com *.google.ro *.facebook.com; font-src 'self' fonts.gstatic.com; connect-src 'self' *.google-analytics.com *.googletagmanager.com *.analytics.google.com *.googlesyndication.com *.googleadservices.com *.doubleclick.net *.google.com *.google.ro *.facebook.com connect.facebook.net; frame-src 'self' https://www.youtube.com https://www.youtube-nocookie.com *.doubleclick.net *.google.com *.facebook.com;",
          },
          {
